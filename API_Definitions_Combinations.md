# API Definitions Combinations

Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Definitions/Combinations
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/AddDesignDefaultCombos.htm`*
...
[Add](Add_{Combinations}.htm)



## Add {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/Add_{Combinations}.htm`*
...
[AddDesignDefaultCombos](AddDesignDefaultCombos.htm)



## ChangeName {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/ChangeName_{Combinations}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/CountCase.htm`*
...
[GetCaseList](GetCaseList.htm)

[SetCaseList](SetCaseList.htm)



## Count {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/Count_{Combinations}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/DeleteCase.htm`*
...
Function DeleteCase(ByVal Name As String, ByVal CType As eCNameType, ByVal CName As String) As Long
...
   'add load case to combo
      ret = SapModel.RespCombo.SetCaseList("COMB1", eCNameType\_LoadCase, "DEAD", 1.4)

   'delete load case from combo
      ret = SapModel.RespCombo.DeleteCase("COMB1", eCNameType\_LoadCase, "DEAD")
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/Delete_{Combinations}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/GetCaseList.htm`*

# GetCaseList (Note:  Newer function available)
...
Function GetCaseList(ByVal Name As String, ByRef NumberItems As Long, ByRef CType() As eCNameType, ByRef CName() As String, ByRef SF() As Double) As Long
...
This function is obsolete and has been superseded by GetCase\_1 as of v22.0.0. This function is maintained for backwards compatibility.

## See Also

[SetCaseList](SetCaseList.htm)

[GetCaseList\_1](GetCaseList_1.htm)



## GetCaseList_1

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/GetCaseList_1.htm`*

# GetCaseList\_1

## Syntax

SapObject.SapModel.RespCombo.GetCaseList\_1

## VB6 Procedure

Function GetCaseList\_1(ByVal Name As String, ByRef NumberItems As Long, ByRef CType() As eCNameType, ByRef CName() As String, ByRef ModeNumber() As Long, ByRef SF() As Double) As Long
...
'add load case to combo
ret = SapModel.RespCombo.SetCaseList\_1("COMB1", eCNameType\_LoadCase, "DEAD", 1, 1.4)

'get all cases and combos included in combo COMB1
ret = SapModel.RespCombo.GetCaseList\_1("COMB1", NumberItems, CType, CName, ModeNumber, SF)
...
This function supersedes [GetCaseList](GetCaseList.htm).

## See Also

[SetCaseList\_1](SetCaseList_1.htm)



## GetNameList {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/GetNameList_{Combinations}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/GetNote.htm`*
...
## GetTypeOAPI {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/GetType_{Combinations}.htm`*
...
[SetTypeOAPI](SetType_{Combinations}.htm)



## SetCaseList

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/SetCaseList.htm`*

# SetCaseList (Note:  Newer function available)
...
This function is obsolete and has been superseded by SetCase\_1 as of v22.0.0. This function is maintained for backwards compatibility.
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/SetCaseList_1.htm`*

# SetCaseList\_1

## Syntax

SapObject.SapModel.RespCombo.SetCaseList\_1

## VB6 Procedure

Function SetCaseList\_1(ByVal Name As String, ByRef CNameType As eCNameType, ByVal CName As String,  ByVal ModeNumber As Long, ByVal SF As Double) As Long
...
The mode number to consider for a modal or buckling load case that is included in the load combination. This only applies when CNameType=0 and the load case type is modal or buckling.
...
This function supersedes [SetCaseList](SetCaseList.htm) as of v22.0.0.
...
*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/SetNote.htm`*
...
## SetTypeOAPI {Combinations}

*Source file: `SAP2000_API_Fuctions/Definitions/Combinations/SetType_{Combinations}.htm`*
...
[GetTypeOAPI](SetType_{Combinations}.htm)
