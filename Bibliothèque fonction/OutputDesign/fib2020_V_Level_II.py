...
def fib2020_V_Level_II(Forces,Sec_geom,Materials,Gamma,Level,Cracked):
    ...
    Input:
        ...
        distance from the centroid of the section (or location of normal force) to the middle of the effective shear depth, Asw_sw is the shear reinforcement per m,
    ...
    M_Ed = Forces[1] # Applied moment at the section to be verified
    V_Ed = Forces[2] # Applied shear force at the section to be verified
