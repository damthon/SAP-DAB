...
Cable_si_BS_max = 0.2  # Backspan cables allowable cable tension as a fraction of the ultimate strength of the cables
...
N_cable_sections = 38     # Number of cable sections
...
s_cables_BS1 = 7900  # Backspan 1 cables deck tributary length 
s_cables_BS2 = 7900  # Backspan 2 cables deck tributary length 
Edge_cables = []
BS1_cables = ['Cables-1','Cables-2','Cables-3','Cables-4','Cables-5','Cables-6','Cables-7','Cables-8','Cables-9','Cables-10','Cables-11','Cables-12','Cables-13','Cables-14','Cables-15','Cables-16','Cables-17','Cables-18','Cables-19'] # Backspan 1cables
BS2_cables =[] # Backspan 2 cables
BS_cables = BS1_cables + BS2_cables
Deck_Temporary_Restraint = ['176','175','174','173','172','171','170','169','168','165','164','163','162','161','160','159','158','83','316'] #'316'

# Deck Sections
Concrete_Deck = 'Deck_2.5m'
Steel_Deck = 'Deck_2.5m_Steel'

# Loads
q_ballast = 50.76 # Ballast
q_rail = 4.5 # Rail
q_equip = 4.0 # Equipment
q_deck_tr = 17.3 # Weight of the transverse plates in the deck

# Iteration parameters 
#Deck_v_allow_v = [800,700,600,500,400,300,250,200,150,120,100,95,90,85,80,75,70] + list(np.linspace(69,10,60))
Deck_v_allow_v = [100,80,70,65,60,55,50,45,40,35,30] + list(np.linspace(29,5,25))
...
ret = SapModel.PropFrame.SetSDSection(Concrete_Deck, 'Concrete')

# Steel material assignment
ret = SapModel.PropFrame.SetSDSection(Steel_Deck, 'S355')
...
Deck_SD = SapModel.PropFrame.GetSDSection(Concrete_Deck)
# Get Shape name
Deck_SD_Shape_Name = Deck_SD[2][0]
# Get polygon parameters: x,y coordinates
Deck_SD_Parameters = SapModel.PropFrame.SDShape.GetPolygon(Concrete_Deck,Deck_SD_Shape_Name)
...
ret = SapModel.PropFrame.SDShape.SetPolygon(Concrete_Deck,Deck_SD_Shape_Name, Deck_SD_Parameters[0] , Deck_SD_Parameters[1], Deck_SD_Parameters[2], Deck_SD_x, 
...
# Get deck area
Deck_area = SapModel.PropFrame.GetSectProps(Steel_Deck)[0]

# Deck self-weight (N/mm)
Deck_SW = Deck_area*w_s + q_deck_tr
# Permanent loads
