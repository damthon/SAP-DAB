...
s_cables = 13000    # Horizontal distance between deck anchor points in the main span
s_cables_e = 9000   # Main span edge cables tributary length
s_cables_BS1 = 3400  # Backspan 1 cables deck tributary length 
s_cables_BS2 = 2140  # Backspan 2 cables deck tributary length 
Edge_cables = ['Cables-18','Cables-19']
BS1_cables =['Cables-1','Cables-2','Cables-3','Cables-4','Cables-5','Cables-6','Cables-7','Cables-8','Cables-9'] # Backspan 1cables
BS2_cables =['Cables-26','Cables-27','Cables-28','Cables-29','Cables-30','Cables-31','Cables-32'] # Backspan 2 cables
BS_cables = BS1_cables + BS2_cables
#Cables_Deck_Temporary_Restraint = ['320','321','322','323','324','325','326','351','350']
...
Deck_v_allow_v = [150,120,100,80,70,65,60,55,50,45,40,35,30] + list(np.linspace(29,5,25))
...
"""
Load_Case_o = 'Staged_Construction-F'
...
ret = SapModel.Analyze.RunAnalysis()
Load_Case = 'Staged_Construction-F_BS'
# Deselect results for all cases
ret = SapModel.Results.Setup.DeselectAllCasesAndCombosForOutput()
# Select desired load case
ret = SapModel.Results.Setup.SetCaseSelectedForOutput(Load_Case)
