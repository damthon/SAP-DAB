...
Cable_si_max = 0.2   # Maximum allowable cable tension as a fraction of the ultimate strength of the cables
Cable_si_min = 0.1   # Minimum allowable cable tension as a fraction of the ultimate strength of the cables
...
Deck_v_allow_v = [40,35,30] + list(np.linspace(29,5,25))
