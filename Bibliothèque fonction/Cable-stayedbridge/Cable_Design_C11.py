...
# Steel (S355)
w_s = 7.85e-5 *1.5    # Weight of S355 steel per unit volume (N/mm3)
...
w_sc = 7.85e-5      # Weight of cablesper unit volume (N/mm3)
...
# Assign weight per unit volume to cables
ret = SapModel.PropMaterial.SetWeightAndMass('Cables', 1, w_sc)
