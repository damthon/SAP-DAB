...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Select
...
*Source file: `SAP2000_API_Fuctions/Select/All.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/ClearSelection.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/Constraint.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/CoordinateRange.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/GetSelected_{Selection_Function}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/Group.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/InvertSelection.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/LinesParallelToCoordAxis.htm`*
...
[LinesParallelToLine](LinesParallelToLine.htm)



## LinesParallelToLine

*Source file: `SAP2000_API_Fuctions/Select/LinesParallelToLine.htm`*
...
Function LinesParallelToLine(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
[LinesParallelToCoordAxis](LinesParallelToCoordAxis.htm)



## PlaneXY

*Source file: `SAP2000_API_Fuctions/Select/PlaneXY.htm`*
...
Function PlaneXY(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PlaneXZ.htm`*
...
Function PlaneXZ(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PlaneYZ.htm`*
...
Function PlaneYZ(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PreviousSelection.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyArea.htm`*
...
[PropertyFrame](PropertyFrame.htm)

[PropertyCable](PropertyCable.htm)

[PropertyTendon](PropertyTendon.htm)

[PropertySolid](PropertySolid.htm)

[PropertyLink](PropertyLink.htm)

[PropertyLinkFD](PropertyLinkFD.htm)

[PropertyMaterial](PropertyMaterial.htm)



## PropertyCable

*Source file: `SAP2000_API_Fuctions/Select/PropertyCable.htm`*
...
Function PropertyCable(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyFrame.htm`*
...
Function PropertyFrame(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyLink.htm`*
...
Function PropertyLink(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyLinkFD.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyMaterial.htm`*
...
Function PropertyMaterial(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/PropertySolid.htm`*
...
*Source file: `SAP2000_API_Fuctions/Select/PropertyTendon.htm`*
...
Function PropertyTendon(ByVal Name As String, Optional ByVal DeSelect As Boolean = False) As Long
...
*Source file: `SAP2000_API_Fuctions/Select/SupportedPoints.htm`*
