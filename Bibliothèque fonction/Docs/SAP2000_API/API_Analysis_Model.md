...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Analysis_Model
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/Count_{Area_Element}.htm`*
...
## GetLoadGravity {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadGravity_{Area_Element}.htm`*
...
Function GetLoadGravity(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef x() As Double, ByRef y() As Double, ByRef z() As Double, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.AreaElm.GetLoadGravity("3-1", NumberItems, AreaName, LoadPat, CSys, x, y, z)
...
## GetLoadPorePressure {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadPorePressure_{Area_Element}.htm`*
...
Function GetLoadPorePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the area element associated with each pore pressure load.
...
      ret = SapModel.AreaElm.GetLoadPorePressure("ALL", NumberItems, AreaName, LoadPat, Value, PatternName, GroupElm)
...
## GetLoadStrain {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadStrain_{Area_Element}.htm`*
...
Function GetLoadStrain(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef Component() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes 1, 2, 3, 4, 5, 6, 7 or 8, indicating the component associated with each strain load.
...
This is an array that includes the strain value. [L/L] for Component = 1, 2, 3, 7 and 8, and [1/L] for Component = 4, 5 and 6
...
## GetLoadSurfacePressure {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadSurfacePressure_{Area_Element}.htm`*
...
Function GetLoadSurfacePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef Face() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the area element associated with each surface pressure load.
...
This is an array that includes -1, -2 or a nonzero, positive integer, indicating the area element face to which the specified load assignment applies.
...
      ret = SapModel.AreaElm.GetLoadSurfacePressure("ALL", NumberItems, AreaName, LoadPat, Face, Value, PatternName, GroupElm)
...
## GetLoadTemperature {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadTemperature_{Area_Element}.htm`*
...
Function GetLoadTemperature(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef MyType() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.AreaElm.GetLoadTemperature("ALL", NumberItems, AreaName, LoadPat, MyType, Value, PatternName, GroupElm)
...
## GetLoadUniform {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLoadUniform_{Area_Element}.htm`*
...
Function GetLoadUniform(ByVal Name As String, ByRef NumberItems As Long, ByRef AreaName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef Dir() As Long, ByRef Value() As Double, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.AreaElm.GetLoadUniform("3", NumberItems, AreaName, LoadPat, CSys, Dir, Value)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetLocalAxes_{Area_Element}.htm`*
...
## GetMatTemp {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetMatTemp_{Area_Element}.htm`*
...
This is blank or the name of a defined joint pattern. If it is blank, the material temperature for the area element is uniform over the element at the value specified by Temp.
...
## GetMaterialOverwrite {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetMaterialOverwrite_{Area_Element}.htm`*
...
## GetModifiers {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetModifiers_{Area_Element}.htm`*
...
## GetNameList {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetNameList_{Area_Element}.htm`*
...
This is a one-dimensional array of area element names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetObj_{Area_Element}.htm`*
...
## GetOffsets {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetOffsets_{Area_Element}.htm`*
...
## GetPoints {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetPoints_{Area_Element}.htm`*
...
## GetProperty {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetProperty_{Area_Element}.htm`*
...
## GetThickness {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetThickness_{Area_Element}.htm`*
...
      ret = SapModel.AreaElm.GetThickness("3", ThicknessType, ThicknessPattern, ThicknessPatternSF, Thickness)
...
## GetTransformationMatrix {Area Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Area_Element/GetTransformationMatrix_{Area_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/Count_{Line_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetEndLengthOffset_{Line_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetInsertionPoint_{Line_Element}.htm`*
...
## GetLoadDeformation {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadDeformation_{Line_Element}.htm`*
...
      ret = SapModel.LineElm.GetLoadDeformation("3-1", NumberItems, LineName, LoadPat, dof1, dof2, dof3, dof4, dof5, dof6, U1, U2, U3, R1, R2, R3)
...
## GetLoadDistributed {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadDistributed_{Line_Element}.htm`*
...
This is an array that includes the relative distance from the I-End of the line element to the start of the distributed load.

RD2

This is an array that includes the relative distance from the I-End of the line element to the end of the distributed load.

Dist1

This is an array that includes the actual distance from the I-End of the line element to the start of the distributed load. [L]

Dist2

This is an array that includes the actual distance from the I-End of the line element to the end of the distributed load. [L]
...
      ret = SapModel.LineElm.GetLoadDistributed("14-1", NumberItems, LineName, LoadPat, MyType, CSys, Dir, RD1, RD2, Dist1, Dist2, Val1, Val2)
...
## GetLoadGravity {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadGravity_{Line_Element}.htm`*
...
Function GetLoadGravity(ByVal Name As String, ByRef NumberItems As Long, ByRef LineName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef x() As Double, ByRef y() As Double, ByRef z() As Double, Optional ByVal ItemType As eItemType = Object) As Long
...
      ret = SapModel.LineElm.GetLoadGravity("3-1", NumberItems, LineName, LoadPat, CSys, x, y, z)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadPoint_{Line_Element}.htm`*
...
## GetLoadStrain {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadStrain_{Line_Element}.htm`*
...
Function GetLoadStrain(ByVal Name As String, ByRef NumberItems As Long, ByRef LineName() As String, ByRef LoadPat() As String, ByRef DOF() As Long, ByRef Val() As Double, ByRef PatternName() As String, Optional ByVal ItemType As eItemType = Object) As Long
...
      ret = SapModel.LineElm.GetLoadStrain("1-1", NumberItems, LineName, LoadPat, DOF, Val, PatternName)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadTargetForce_{Line_Element}.htm`*
...
## GetLoadTemperature {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLoadTemperature_{Line_Element}.htm`*
...
Function GetLoadTemperature(ByVal Name As String, ByRef NumberItems As Long, ByRef LineName() As String, ByRef LoadPat() As String, ByRef MyType() As Long, ByRef Val() As Double, ByRef PatternName() As String, Optional ByVal ItemType As eItemType = Object) As Long
...
      ret = SapModel.LineElm.GetLoadTemperature("ALL", NumberItems, LineName, LoadPat, MyType, Val, PatternName, GroupElm)
...
## GetLocalAxes {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetLocalAxes_{Line_Element}.htm`*
...
## GetMatTemp {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetMatTemp_{Line_Element}.htm`*
...
This is blank or the name of a defined joint pattern. If it is blank, the material temperature for the line element is uniform along the element at the value specified by Temp.
...
## GetMaterialOverwrite {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetMaterialOverwrite_{Line_Element}.htm`*
...
## GetModifiers {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetModifiers_{Line_Element}.htm`*
...
## GetNameList {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetNameList_{Line_Element}.htm`*
...
This is a one-dimensional array of line element names. The MyName array is created as a dynamic, zero-based, array by the APIuser:
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetObj_{Line_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetPDeltaForce_{Line_Element}.htm`*
...
## GetPoints {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetPoints_{Line_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetProperty_{Line_Element}.htm`*
...
## GetReleases {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetReleases_{Line_Element}.htm`*
...
## GetTCLimits {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetTCLimits_{Line_Element}.htm`*
...
      ret = SapModel.LineElm.GetTCLimits("1-1", LimitCompressionExists, LimitCompression, LimitTensionExists, LimitTension)
...
## GetTransformationMatrix {Line Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Line_Element/GetTransformationMatrix_{Line_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/Count_{Link_Element}.htm`*
...
## GetLoadDeformation {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetLoadDeformation_{Link_Element}.htm`*
...
      ret = SapModel.LinkElm.GetLoadDeformation("ALL", NumberItems, LinkName, LoadPat, dof1, dof2, dof3, dof4, dof5, dof6, U1, U2, U3, R1, R2, R3, GroupElm)
...
## GetLoadGravity {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetLoadGravity_{Link_Element}.htm`*
...
      ret = SapModel.LinkElm.GetLoadGravity("ALL", NumberItems, LinkName, LoadPat, CSys, x, y, z, GroupElm)
...
## GetLoadTargetForce {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetLoadTargetForce_{Link_Element}.htm`*
...
      ret = SapModel.LinkElm.GetLoadTargetForce("ALL", NumberItems, LinkName, LoadPat, dof1, dof2, dof3, dof4, dof5, dof6, P, V2, V3, T, M2, M3, T1, T2, T3, T4, T5, T6, GroupElm)
...
## GetLocalAxes {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetLocalAxes_{Link_Element}.htm`*
...
## GetNameList {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetNameList_{Link_Element}.htm`*
...
This is a one-dimensional array of link element names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetOb_{Link_Element}j.htm`*
...
## GetPoints {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetPoints_{Link_Element}.htm`*
...
## GetPropertyFD {Link Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetPropertyFD_{Link_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetProperty_{Link_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Link_Element/GetTransformationMatrix_{Link_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/Count_{Plane_Element}.htm`*
...
## GetLoadGravity {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadGravity_{Plane_Element}.htm`*
...
Function GetLoadGravity(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef x() As Double, ByRef y() As Double, ByRef z() As Double, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.PlaneElm.GetLoadGravity("3-1", NumberItems, PlaneName, LoadPat, CSys, x, y, z)
...
## GetLoadPorePressure {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadPorePressure_{Plane_Element}.htm`*
...
Function GetLoadPorePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the plane element associated with each pore pressure load.
...
      ret = SapModel.PlaneElm.GetLoadPorePressure("ALL", NumberItems, PlaneName, LoadPat, Value, PatternName, GroupElm)
...
## GetLoadRotate {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadRotate_{Plane_Element}.htm`*
...
Function GetLoadRotate(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.PlaneElm.GetLoadRotate("ALL", NumberItems, PlaneName, LoadPat, Value, GroupElm)
...
## GetLoadStrain {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadStrain_{Plane_Element}.htm`*
...
Function GetLoadStrain(ByVal Name As String, ByRef NumberItems
As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef
Component() As Long, ByRef Value() As Double, ByRef PatternName() As String,
...
The name of an existing plane element or group, depending
on the value of the ItemType item.

NumberItems

The total number of strain loads retrieved for the specified
plane elements.

PlaneName

This is an array that includes the name of the plane
element associated with each strain load.

LoadPat

This is an array that includes the name of the load
pattern associated with each strain load.

Component

This is an array that includes 1, 2, 3, 4, 5 or 6, indicating
the component associated with each strain load.
...
This is an array that includes the joint pattern name,
if any, used to specify the strain load.
...
If this item is ObjectElm, the load assignments are
retrieved for the plane elements corresponding to the area object specified
by the Name item.

If this item is Element, the load assignments are retrieved
for the plane element specified by the Name item.

If this item is GroupElm, the load assignments are retrieved
for the plane elements corresponding to all area objects included in the
group specified by the Name item.

If this item is SelectionElm, the load assignments are
retrieved for plane elements corresponding to all selected area objects,
and the Name item is ignored.

## Remarks

This function retrieves the strain load assignments
to plane elements.

The function returns zero if the strain load assignments
are successfully retrieved; otherwise it returns a nonzero value.
...
"Membrane", 1, 0.001, , , Group)

   'create analysis model
      ret = SapModel.Analyze.CreateAnalysisModel

   'get plane element strain load
      ret = SapModel.PlaneElm.GetLoadStrain("3",
NumberItems, PlaneName, LoadPat, Component, Value, PatternName)
...
## GetLoadSurfacePressure {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadSurfacePressure_{Plane_Element}.htm`*
...
Function GetLoadSurfacePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef Face() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the plane element associated with each surface pressure load.
...
      ret = SapModel.PlaneElm.GetLoadSurfacePressure("ALL", NumberItems, PlaneName, LoadPat, Face, Value, PatternName, GroupElm)
...
## GetLoadTemperature {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadTemperature_{Plane_Element}.htm`*
...
Function GetLoadTemperature(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef MyType() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.PlaneElm.GetLoadTemperature("ALL", NumberItems, PlaneName, LoadPat, MyType, Value, PatternName, GroupElm)
...
## GetLoadUniform {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLoadUniform_{Plane_Element}.htm`*
...
Function GetLoadUniform(ByVal Name As String, ByRef NumberItems As Long, ByRef PlaneName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef Dir() As Long, ByRef Value() As Double, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
   'assign area object uniform loads
      ret = SapModel.AreaObj.SetLoadUniform("ALL", "Membrane", -0.01, 2, False, "Local", Group)

   'create analysis model
      ret = SapModel.Analyze.CreateAnalysisModel

   'get plane element uniform load
      ret = SapModel.PlaneElm.GetLoadUniform("3", NumberItems, PlaneName, LoadPat, CSys, Dir, Value)
...
## GetLocalAxes {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetLocalAxes_{Plane_Element}.htm`*
...
## GetMatTemp {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetMatTemp_{Plane_Element}.htm`*
...
This is blank or the name of a defined joint pattern. If it is blank, the material temperature for the plane element is uniform over the element at the value specified by Temp.
...
## GetNameList {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetNameList_{Plane_Element}.htm`*
...
This is a one-dimensional array of plane element names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
## GetObj {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetObj_{Plane_Element}.htm`*
...
## GetPoints {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetPoints_{Plane_Element}.htm`*
...
## GetProperty {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetProperty_{Plane_Element}.htm`*
...
## GetTransformationMatrix {Plane Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Plane_Element/GetTransformationMatrix_{Plane_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/CountConstraint_{Point_Element}.htm`*
...
[GetConstraint](GetConstraint_{Point_Element}.htm)



## CountLoadDispl {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/CountLoadDispl_{Point_Element}.htm`*
...
[GetLoadDispl](GetLoadDispl_{Point_Element}.htm)



## CountLoadForce {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/CountLoadForce_{Point_Element}.htm`*
...
[GetLoadForce](GetLoadForce_{Point_Element}.htm)



## CountRestraint {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/CountRestraint_{Point_Element}.htm`*
...
[GetRestraint](GetRestraint_{Point_Element}.htm)



## CountSpring {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/CountSpring_{Point_Element}.htm`*
...
[GetSpring](GetSpring_{Point_Element}.htm)

[GetSpringCoupled](GetSpringCoupled_{Point_Element}.htm)



## Count {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/Count_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetConnectivity_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetConstraint_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetCoordCartesian_{Point_Element}.htm`*
...
[GetCoordCylindrical](GetCoordCylindrical_{Point_Element}htm.htm)

[GetCoordSpherical](GetCoordSpherical_{Point_Element}.htm)



## GetCoordCylindrical {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetCoordCylindrical_{Point_Element}htm.htm`*
...
[GetCoordCartesian](GetCoordCartesian_{Point_Element}.htm)

[GetCoordSpherical](GetCoordSpherical_{Point_Element}.htm)



## GetCoordSpherical {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetCoordSpherical_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetLoadDispl_{Point_Element}.htm`*
...
## GetLoadForce {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetLoadForce_{Point_Element}.htm`*
...
      ret = SapModel.PointElm.GetLoadForce("ALL", NumberItems, PointName, LoadPat, LCStep, CSys, F1, F2, F3, M1, M2, M3, GroupElm)
...
## GetLocalAxes {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetLocalAxes_{Point_Element}.htm`*
...
## GetMergeNumber {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetMergeNumber_{Point_Element}.htm`*
...
## GetNameList {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetNameList_{Point_Element}.htm`*
...
This is a one-dimensional array of point element names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
## GetObj {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetObj_{Point_Element}.htm`*
...
The name of the object or defined item associated with
the specified point element. The type of object or item is determined
from the ObjType variable.

ObjType

A number indicating the type of object or defined item
...
## GetPatternValue {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetPatternValue_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetRestraint_{Point_Element}.htm`*
...
## GetSpringCoupled {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetSpringCoupled_{Point_Element}.htm`*
...
[IsSpringCoupled](IsSpringCoupled_{Point_Element}.htm)



## GetSpring {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetSpring_{Point_Element}.htm`*
...
## GetTransformationMatrix {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/GetTransformationMatrix_{Point_Element}.htm`*
...
## IsSpringCoupled {Point Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Point_Element/IsSpringCoupled_{Point_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/Count_{Solid_Element}.htm`*
...
## GetLoadGravity {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLoadGravity_{Solid_Element}.htm`*
...
Function GetLoadGravity(ByVal Name As String, ByRef NumberItems As Long, ByRef SolidName() As String, ByRef LoadPat() As String, ByRef CSys() As String, ByRef x() As Double, ByRef y() As Double, ByRef z() As Double, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.SolidElm.GetLoadGravity("3-1", NumberItems, SolidName, LoadPat, CSys, x, y, z)
...
## GetLoadPorePressure {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLoadPorePressure_{Solid_Element}.htm`*
...
Function GetLoadPorePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef SolidName() As String, ByRef LoadPat() As String, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the solid element associated with each pore pressure load.
...
      ret = SapModel.SolidElm.GetLoadPorePressure("ALL", NumberItems, SolidName, LoadPat, Value, PatternName, GroupElm)
...
## GetLoadStrain {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLoadStrain_{Solid_Element}.htm`*
...
Function GetLoadStrain(ByVal Name As String, ByRef NumberItems As Long, ByRef SolidName() As String, ByRef LoadPat() As String, ByRef Component() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
      ret = SapModel.SolidElm.GetLoadStrain("1", NumberItems, SolidName, LoadPat, Component, Value, PatternName)
...
## GetLoadSurfacePressure {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLoadSurfacePressure_{Solid_Element}.htm`*
...
Function GetLoadSurfacePressure(ByVal Name As String, ByRef NumberItems As Long, ByRef SolidName() As String, ByRef LoadPat() As String, ByRef Face() As Long, ByRef Value() As Double, ByRef PatternName() As String, Optional ByVal ItemTypeElm As eItemTypeElm = Element) As Long
...
This is an array that includes the name of the solid element associated with each surface pressure load.
...
This is an array that includes 1, 2, 3, 4, 5 or 6, indicating the solid element face to which the specified load assignment applies.
...
      ret = SapModel.SolidElm.GetLoadSurfacePressure("ALL", NumberItems, SolidName,LoadPat, Face, Value, PatternName, GroupElm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLoadTemperature_{Solid_Element}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetLocalAxes_{Solid_Element}.htm`*
...
## GetMatTemp {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetMatTemp_{Solid_Element}.htm`*
...
This is blank or the name of a defined joint pattern. If it is blank, the material temperature for the solid element is uniform over the element at the value specified by Temp.
...
## GetNameList {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetNameList_{Solid_Element}.htm`*
...
## GetObj {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetObj_{Solid_Element}.htm`*
...
## GetPoints {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetPoints_{Solid_Element}.htm`*
...
## GetProperty {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetProperty_{Solid_Element}.htm`*
...
## GetTransformationMatrix {Solid Element}

*Source file: `SAP2000_API_Fuctions/Analysis_Model/Solid_Element/GetTransformationMatrix_{Solid_Element}.htm`*
