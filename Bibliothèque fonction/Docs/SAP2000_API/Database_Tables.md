...
Source: CSI OAPI Documentation (SAP2000) — Database_Tables
...
*Source file: `Database_Tables/ApplyEditedTables.htm`*
...
the tables stored in the table list using the SetTableForEditing... functions.
...
[SetTableForEditingArray](SetTableforEditingArray.htm)

[SetTableForEditingCSVFile](SetTableForEditingCSVFile.htm)

[SetTableForEditngCSVString](SetTableForEditingCSVString.htm)



## CancelTableEditing

*Source file: `Database_Tables/CancelTableEditing.htm`*
...
using one of the SetTableForEditing... functions.
...
*Source file: `Database_Tables/GetAllFieldsInTable.htm`*
...
*Source file: `Database_Tables/GetAllTables.htm`*
...
Returned Item: False means
data is available in the model to fill the table. True
...
[GetAvailableTables](GetAvailableTables.htm)



## GetAvailableTables

*Source file: `Database_Tables/GetAvailableTables.htm`*
...
[GetAllTables](GetAllTables.htm)



## GetElementVirtualWorkNamedSetsSelectedForDisplay

*Source file: `Database_Tables/GetElementVirtualWorkNamedSetsSelectedForDisplay.htm`*
...
Function GetElementVirtualWorkNamedSetsSelectedForDisplay
(ByRef NumberSelectedElementVirtualWorkNamedSets As Integer, ByRef ElementVirtualWorkNamedSetList()
As String) As Integer
...
The number of element virtual work named sets selected
for display in the analysis result tables.

ElementVirtualWorkNamedSetList

A zero-based list of the names of the element virtual
work named sets selected for display in the analysis result tables.

## Remarks

This function returns the element virtual work named
...
   'get element virtual work named sets selected for display
in the analysis result tables
      ret = SapModel. DatabaseTables.GetElementVirtualWorkNamedSetsSelectedForDisplay
...
[SetElementVirtualWorkNamedSetsSelectedForDisplay](SetElementVirtualWorkNamedSetsSelectedForDisplay.htm)



## GetGeneralizedDisplacementsSelectedForDisplay

*Source file: `Database_Tables/GetGeneralizedDisplacementsSelectedForDisplay.htm`*
...
Function GetGeneralizedDisplacementsSelectedForDisplay
(ByRef NumberSelectedGeneralizedDisplacements As Integer, ByRef GeneralizedDisplacementList()
As String) As Integer
...
The number of generalized displacements selected for
display in the analysis result tables.

GeneralizedDisplacementList

A zero-based list of the names of the generalized displacements
selected for display in the analysis result tables.

## Remarks

This function returns the generalized displacements
selected for display in the analysis result tables.
...
   'get generalized displacements selected for display in
the analysis result tables
      ret = SapModel. DatabaseTables.GetGeneralizedDisplacementsSelectedForDisplay
(NumberItems, ItemList)
...
[SetGeneralizedDisplacementsSelectedForDisplay](SetGeneralizedDisplacementsSelectedForDisplay.htm)



## GetJointResponseSpectraNamedSetsSelectedForDisplay

*Source file: `Database_Tables/GetJointResponseSpectraNamedSetsSelectedForDisplay.htm`*
...
Function GetJointResponseSpectraNamedSetsSelectedForDisplay
(ByRef NumberSelectedJointResponseSpectraNamedSets As Integer, ByRef JointResponseSpectraNamedSetList()
As String) As Integer
...
The number of joint response spectra named sets selected
for display in the analysis result tables.

JointResponseSpectraNamedSetList

A zero-based list of the names of the joint response
spectra named sets selected for display in the analysis result tables.

## Remarks

This function returns the joint response spectra named
sets selected for display in the analysis result tables.
...
   'get joint response spectra named sets selected for display
in the analysis result tables
      ret = SapModel. DatabaseTables.GetJointResponseSpectraNamedSetsSelectedForDisplay
(NumberItems, ItemList)
...
[SetJointResponseSpectraNamedSetsSelectedForDisplay](SetJointResponseSpectraNamedSetsSelectedForDisplay.htm)



## GetLoadCasesSelectedForDisplay

*Source file: `Database_Tables/GetLoadCasesSelectedForDisplay.htm`*
...
Function GetLoadCasesSelectedForDisplay (ByRef NumberSelectedLoadCases
 As Integer, ByRef LoadCaseList As As String()) As Integer

## Parameters

NumberSelectedLoadCases

Returned Item: The number of load cases selected for
table display.
...
displaying load assignments on the model.
...
[SetLoadCasesSelectedForDisplay](SetLoadCasesSelectedForDisplay.htm)



## GetLoadCombinationsSelectedForDisplay

*Source file: `Database_Tables/GetLoadCombinationsSelectedForDisplay.htm`*
...
[SetLoadCombinationsSelectedForDisplay](SetLoadCombinationsSelectedForDisplay.htm)



## GetLoadPatternsSelectedForDisplay

*Source file: `Database_Tables/GetLoadPatternsSelectedForDisplay.htm`*
...
(ByRef NumberSelectedLoadPatterns  As
Integer, ByRef LoadPatternList As As
String()) As Integer
...
Returned Item: The number of load pattern
selected for table display.

LoadPatternList

Returned Item: The zero-based
list of load patterns
selected for table display.

## Remarks

Returns a list of load patterns
that are selected for table display.

This list sets the load patterns that are included when
displaying load assignments on the model.
...
[SetLoadPatternsSelectedForDisplay](SetLoadPatternsSelectedForDisplay.htm)



## GetObsoleteTableKeyList

*Source file: `Database_Tables/GetObsoleteTableKeyList.htm`*
...
*Source file: `Database_Tables/GetPlotFunctionTracesNamedSetsSelectedForDisplay.htm`*
...
[SetPlotFunctionTracesNamedSetsSelectedForDisplay](SetPlotFunctionTracesNamedSetsSelectedForDisplay.htm)



## GetPushoverNamedSetsSelectedForDisplay

*Source file: `Database_Tables/GetPushoverNamedSetsSelectedForDisplay.htm`*
...
Function GetPushoverNamedSetsSelectedForDisplay (ByRef
NumberSelectedPushoverNamedSets As Integer, ByRef PushoverNamedSetList()
As String) As Integer
...
The number of pushover named sets selected for display
in the analysis result tables.

PushoverNamedSetList

A zero-based list of the names of the pushover named
sets selected for display in the analysis result tables.

## Remarks

This function returns the pushover named sets selected
for display in the analysis result tables.
...
   'get pushover named sets selected for display in the
analysis result tables
      ret = SapModel. DatabaseTables.GetPushoverNamedSetsSelectedForDisplay
(NumberItems, ItemList)
...
[SetPushoverNamedSetsSelectedForDisplay](SetPushoverNamedSetsSelectedForDisplay.htm)



## GetSectionCutsSelectedForDisplay

*Source file: `Database_Tables/GetSectionCutsSelectedForDisplay.htm`*
...
Function GetSectionCutsSelectedForDisplay (ByRef NumberSelectedSectionCuts
As Integer, ByRef SectionCutList() As String) As Integer

## Parameters

NumberSelectedSectionCuts

The number of section cuts selected for display in the
analysis result tables.

SectionCutList

A zero-based list of the names of the section cuts selected
for display in the analysis result tables.

## Remarks

This function returns the section cuts selected for
display in the analysis result tables.
...
   'get section cuts selected for display in the analysis
result tables
      ret = SapModel. DatabaseTables.GetSectionCutsSelectedForDisplay
(NumberItems, ItemList)
...
[SetSectionCutsSelectedForDisplay](SetSectionCutsSelectedForDisplay.htm)



## GetTableForDisplayXMLString

*Source file: `Database_Tables/GetTableForDisplayXMLString.htm`*
...
Function GetTableForDisplayXMLString (TableKey
As String, ByRef FieldKeyList As String(),
GroupName As String(), IncludeSchema As
Boolean, ByRef TableVersion As Integer,
ByRef XMLTableData As String) As Integer
...
*Source file: `Database_Tables/GetTableForEditingArray.htm`*
...
Function GetTableForEditingArray (TableKey As String(), GroupName As String(), ByRef TableVersion As Integer, ByRef FieldKeysIncluded As String(), ByRef NumberRecords As Integer, ByRef TableData As String()) As Integer
...
Returned Item: A zero-based array listing the field keys associated with the specified table for which data is reported in the order it is reported in the TableData array. These are essentially the column headers of the data returned in TableData.
...
*Source file: `Database_Tables/GetTableForEditingCSVString.htm`*
...
Function GetTableForEditingCSVString (TableKey As String, GroupName As String, ByRef TableVersion As Integer, ByRef csvString As String, Optional sepChar as string = ",") As Integer
...
*Source file: `Database_Tables/GetTableOutputOptionsForDisplay.htm`*
...
[SetTableOutputOptionsForDisplay](SetTableOutputOptionsForDisplay.htm)



## GetTableForDisplayArray

*Source file: `Database_Tables/GetTableforDisplayArray.htm`*
...
Function GetTableForDisplayArray (TableKey
As String(), ByRef FieldKeyList As
String(), GroupName As String(), ByRef
TableVersion As Integer, ByRef FieldKeysIncluded
As String(), ByRef NumberRecords As Integer,
ByRef TableData As String() ) As Integer
...
the order it is reported in the TableData
...
FieldsKeysIncluded array and the NumberRecords is five.
...
[GetTableForEditingArray](GetTableForEditingArray.htm)



## GetTableForDisplayCSVString

*Source file: `Database_Tables/GetTableforDisplayCSVString.htm`*
...
Function GetTableForDisplayCSVString (TableKey
As String(), ByRef FieldKeyList As
String(), GroupName As String(), ByRef
TableVersion As Integer, csvString
...
[GetTableForEditingCSVString](GetTableForEditingCSVString.htm)



## GetTableForDisplayCSVFile

*Source file: `Database_Tables/GetTableforDisplayCSVfile.htm`*
...
Function GetTableForDisplayCSVFile (TableKey
As String(), ByRef FieldKeyList As
String(), GroupName As String(), ByRef
TableVersion As Integer, csvFilePath
As String(), Optional sepChar as string = ",") As Integer
...
Returns data for a single table in a CSV file. If there
is nothing to be shown in the table then no data is returned
...
[GetTableForEditingCSVFile](GetTableforEditingCSVFile.htm)



## GetTableForEditingCSVFile

*Source file: `Database_Tables/GetTableforEditingCSVFile.htm`*
...
Function GetTableForEditingCSVFile (TableKey As String(), GroupName As String(), ByRef TableVersion As Integer, csvFilePath As String, Optional sepChar as string = ",") As Integer
...
*Source file: `Database_Tables/SetElementVirtualWorkNamedSetsSelectedForDisplay.htm`*
...
Function SetElementVirtualWorkNamedSetsSelectedForDisplay
(ByRef ElementVirtualWorkNamedSetList() As String) As Integer

## Parameters

ElementVirtualWorkNamedSetList

The zero-based list of element virtual work named sets
selected for table display.

## Remarks

This function sets the element virtual work named sets
that are included when displaying analysis results. If no element virtual
work named sets are to be selected then the list should include a blank
string.
...
This example assumes that a file MyModel.sdb exists
and that it contains element virtual work named sets named Set1 and Set2.
...
   'set element virtual work named sets selected for display
in the analysis result tables
...
[GetElementVirtualWorkNamedSetsSelectedForDisplay](GetElementVirtualWorkNamedSetsSelectedForDisplay.htm)



## SetGeneralizedDisplacementsSelectedForDisplay

*Source file: `Database_Tables/SetGeneralizedDisplacementsSelectedForDisplay.htm`*
...
Function SetGeneralizedDisplacementsSelectedForDisplay
(ByRef GeneralizedDisplacementList() As String) As Integer

## Parameters

GeneralizedDisplacementList

The zero-based list of generalized displacements selected
for table display.

## Remarks

This function sets the generalized displacements that
are included when displaying analysis results. If no generalized displacements
are to be selected then the list should include a blank string.
...
This example assumes that a file MyModel.sdb exists
and that it contains generalized displacements named GDisp1 and GDisp2.
...
   'set generalized displacements selected for display in
the analysis result tables
...
[GetGeneralizedDisplacementsSelectedForDisplay](GetGeneralizedDisplacementsSelectedForDisplay.htm)



## SetJointResponseSpectraNamedSetsSelectedForDisplay

*Source file: `Database_Tables/SetJointResponseSpectraNamedSetsSelectedForDisplay.htm`*
...
Function SetJointResponseSpectraNamedSetsSelectedForDisplay
(ByRef JointResponseSpectraNamedSetList() As String) As Integer

## Parameters

JointResponseSpectraNamedSetList

The zero-based list of joint response spectra named
sets selected for table display.

## Remarks

This function sets the joint response spectra named
sets that are included when displaying analysis results. If no joint response
spectra named sets are to be selected then the list should include a blank
string.
...
This example assumes that a file MyModel.sdb exists
and that it contains joint response spectra named sets named Set1 and
Set2.
...
   'set joint response spectra named sets selected for display
in the analysis result tables
...
[GetJointResponseSpectraNamedSetsSelectedForDisplay](GetJointResponseSpectraNamedSetsSelectedForDisplay.htm)



## SetLoadCasesSelectedForDisplay

*Source file: `Database_Tables/SetLoadCasesSelectedForDisplay.htm`*
...
the LoadCaseList item should include a
single blank string.
...
[GetLoadCasesSelectedForDisplay](GetLoadCasesSelectedForDisplay.htm)



## SetLoadCombinationsSelectedForDisplay

*Source file: `Database_Tables/SetLoadCombinationsSelectedForDisplay.htm`*
...
then the LoadCombinationList item should
...
[GetLoadCombinationsSelectedForDisplay](GetLoadCombinationsSelectedForDisplay.htm)



## SetLoadPatternsSelectedForDisplay

*Source file: `Database_Tables/SetLoadPatternsSelectedForDisplay.htm`*
...
(ByRef LoadPatternList As As String())
As Integer
...
This list sets the load patterns that are included when
displaying load assignments on the model. If no load patterns are to be
selected then the LoadPatternList item
should include a single blank string.
...
[GetLoadPatternsSelectedForDisplay](GetLoadPatternsSelectedForDisplay.htm)



## SetPlotFunctionTracesNamedSetsSelectedForDisplay

*Source file: `Database_Tables/SetPlotFunctionTracesNamedSetsSelectedForDisplay.htm`*
...
[GetPlotFunctionTracesNamedSetsSelectedForDisplay](GetPlotFunctionTracesNamedSetsSelectedForDisplay.htm)



## SetPushoverNamedSetsSelectedForDisplay

*Source file: `Database_Tables/SetPushoverNamedSetsSelectedForDisplay.htm`*
...
Function SetPushoverNamedSetsSelectedForDisplay (ByRef
...
The zero-based list of pushover named sets selected
for table display.

## Remarks

This function sets the pushover named sets that are
included when displaying analysis results. If no pushover named sets are
to be selected then the list should include a blank string.

The
function returns zero if the information is successfully set, otherwise
it returns a nonzero value.

## VBA Example

This example assumes that a file MyModel.sdb exists
and that it contains pushover named sets named Set1 and Set2.
...
   'set pushover named sets selected for display in the
analysis result tables
...
[GetPushoverNamedSetsSelectedForDisplay](GetPushoverNamedSetsSelectedForDisplay.htm)



## SetSectionCutsSelectedForDisplay

*Source file: `Database_Tables/SetSectionCutsSelectedForDisplay.htm`*
...
Function SetSectionCutsSelectedForDisplay (ByRef SectionCutList()
As String) As Integer
...
The zero-based list of section cuts selected for table
display.

## Remarks

This function sets the section cuts that are included
when displaying analysis results. If no section cuts are to be selected
then the list should include a blank string.
...
This example assumes that a file MyModel.sdb exists
and that it contains section cuts named SCut1 and SCut2.
...
   'set section cuts selected for display in the analysis
result tables
...
[GetSectionCutsSelectedForDisplay](GetSectionCutsSelectedForDisplay.htm)



## SetTableForEditingCSVFile

*Source file: `Database_Tables/SetTableForEditingCSVFile.htm`*
...
Function SetTableForEditingCSVFile (TableKey
As String(), ByRef TableVersion As
Integer, csvFilePath As String(), Optional
...
table list until either the [ApplyEditedTables](ApplyEditedTables.htm)
or [CancelTableEditing](CancelTableEditing.htm) command is
issued.
...
[GetTableForDisplayCSVFile](GetTableforDisplayCSVfile.htm)



## SetTableForEditingCSVString

*Source file: `Database_Tables/SetTableForEditingCSVString.htm`*
...
Function SetTableForEditingCSVString (TableKey
As String, ByRef TableVersion As Integer,
ByRef csvString As String, Optional sepChar
as string = ",") As Integer
...
to a stored table list until either the [ApplyEditedTables](ApplyEditedTables.htm)
or [CancelTableEditing](CancelTableEditing.htm) command is
issued
...
[GetTableForDisplayCSVString](GetTableforDisplayCSVString.htm)



## SetTableOutputOptionsForDisplay

*Source file: `Database_Tables/SetTableOutputOptionsForDisplay.htm`*
...
[GetTableOutputOptionsForDisplay](GetTableOutputOptionsForDisplay.htm)



## SetTableForEditingArray

*Source file: `Database_Tables/SetTableforEditingArray.htm`*
...
Function SetTableForEditingArray (TableKey
As String(), ByRef TableVersion As
Integer, ByRef FieldKeysIncluded As String(),
NumberRecords As Integer, ByRef TableData
As String() ) As Integer
...
order it is reported in the TableData array.
These are essentially the column headers of the data reported in TableData.
...
table data, excluding headers, reported row by row. See [GetTableForDisplayArray](GetTableForEditingArray.htm)
...
[GetTableForDisplayArray](GetTableforDisplayArray.htm)



## ShowTablesInExcel

*Source file: `Database_Tables/ShowTablesInExcelMethod.htm`*
...
    ret = SapModel.File.New2DFrame(e2DFrameType\_PortalFrame,
2, 10, 3, 20)
