...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Analysis_Results
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/DeselectAllCasesAndCombosForOutput.htm`*
...
[GetCaseSelectedForOutput](GetCaseSelectedForOutput.htm)

[GetComboSelectedForOutput](GetComboSelectedForOutput.htm)

[SetCaseSelectedForOutput](SetCaseSelectedForOutput.htm)

[SetComboSelectedForOutput](SetComboSelectedForOutput.htm)



## GetCaseSelectedForOutput

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetCaseSelectedForOutput.htm`*
...
[DeselectAllCasesAndCombosForOutput](DeselectAllCasesAndCombosForOutput.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetComboSelectedForOutput.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionBaseReactLoc.htm`*
...
Function GetOptionBaseReactLoc(ByRef gx As Double, ByRef gy As Double, ByRef gz As Double) As Long
...
[SetOptionBaseReactLoc](SetOptionBaseReactLoc.htm)



## GetOptionBucklingMode

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionBucklingMode.htm`*
...
[SetOptionBucklingMode](SetOptionBucklingMode.htm)



## GetOptionDirectHist

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionDirectHist.htm`*
...
[SetOptionDirectHist](SetOptionDirectHist.htm)



## GetOptionModalHist

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionModalHist.htm`*
...
[SetOptionModalHist](SetOptionModalHist.htm)



## GetOptionModeShape

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionModeShape.htm`*
...
[SetOptionModeShape](SetOptionModeShape.htm)



## GetOptionMultiStepStatic

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionMultiStepStatic.htm`*
...
[SetOptionMultiStepStatic](SetOptionMultiStepStatic.htm)



## GetOptionMultiValuedCombo

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionMultiValuedCombo.htm`*
...
[SetOptionMultiValuedCombo](SetOptionMultiValuedCombo.htm)



## GetOptionNLStatic

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionNLStatic.htm`*
...
[SetOptionNLStatic](SetOptionNLStatic.htm)



## GetOptionPSD

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionPSD.htm`*
...
[SetOptionPSD](SetOptionPSD.htm)



## GetOptionSteadyState

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetOptionSteadyState.htm`*
...
Function GetOptionSteadyState(ByRef Value As Long, ByRef SteadyStateOption As Long) As Long
...
[SetOptionSteadyState](SetOptionSteadyState.htm)



## GetSectionCutSelectedForOutput

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/GetSectionCutSelectedForOutput.htm`*
...
[SelectAllSectionCutsForOutput](SelectAllSectionCutsForOutput.htm)

[SetSectionCutSelectedForOutput](SetSectionCutSelectedForOutput.htm)



## SelectAllSectionCutsForOutput

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SelectAllSectionCutsForOutput.htm`*
...
[GetSectionCutSelectedForOutput](GetSectionCutSelectedForOutput.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetCaseSelectedForOutput.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetComboSelectedForOutput.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionBaseReactLoc.htm`*
...
Function SetOptionBaseReactLoc(ByVal gx As Double, ByVal gy As Double, ByVal gz As Double) As Long
...
[GetOptionBaseReactLoc](GetOptionBaseReactLoc.htm)



## SetOptionBucklingMode

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionBucklingMode.htm`*
...
[GetOptionBucklingMode](GetOptionBucklingMode.htm)



## SetOptionDirectHist

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionDirectHist.htm`*
...
[GetOptionDirectHist](GetOptionDirectHist.htm)



## SetOptionModalHist

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionModalHist.htm`*
...
[GetOptionModalHist](GetOptionModalHist.htm)



## SetOptionModeShape

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionModeShape.htm`*
...
[GetOptionModeShape](GetOptionModeShape.htm)



## SetOptionMultiStepStatic

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionMultiStepStatic.htm`*
...
[GetOptionMultiStepStatic](GetOptionMultiStepStatic.htm)



## SetOptionMultiValuedCombo

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionMultiValuedCombo.htm`*
...
[GetOptionMultiValuedCombo](GetOptionMultiValuedCombo.htm)



## SetOptionNLStatic

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionNLStatic.htm`*
...
[GetOptionNLStatic](GetOptionNLStatic.htm)



## SetOptionPSD

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionPSD.htm`*
...
[GetOptionPSD](GetOptionPSD.htm)



## SetOptionSteadyState

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetOptionSteadyState.htm`*
...
[GetOptionSteadyState](GetOptionSteadyState.htm)



## SetSectionCutSelectedForOutput

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Analysis_Results_Setup/SetSectionCutSelectedForOutput.htm`*
...
ret = SapModel.Results.Setup.SetSectionCutSelectedForOutput("SCut1", True)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/Analysis_Results_Remarks.htm`*

# Analysis Results Remarks

The analysis results are returned in a collection of one-dimensional result arrays. Each result array is created as a dynamic array by the API user. As an example, in VBA a dynamic string array is defined by:

   Dim MyArray() as String

The array is dimensioned to (NumberResults– 1) inside the Sap2000 program, filled with the result values, and returned to the API user.
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/Analysis_Results_Step_Number.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/Analysis_Results_Step_Type.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaForceShell.htm`*
...
This is an array that includes the step type, if any, for each result. See [Analysis Results Step Type](Analysis_Results_Step_Type.htm).

StepNum

This is an array that includes the step number, if any, for each result. See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
...
See [Analysis Results Remarks](Analysis_Results_Remarks.htm) for more information.
...
[AreaStressShell](AreaStressShell.htm)

[AreaStressShellLayered](AreaStressShellLayered.htm)

[AreaJointForcePlane](AreaJointForcePlane.htm)



## AreaJointForcePlane

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaJointForcePlane.htm`*
...
      ret = SapModel.Results.AreaJointForcePlane("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
[AreaStressPlane](AreaStressPlane.htm)



## AreaJointForceShell

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaJointForceShell.htm`*
...
      ret = SapModel.Results.AreaJointForceShell("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
[AreaForceShell](AreaForceShell.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaStrainShell.htm`*
...
[AreaStrainShellLayered](AreaStrainShellLayered.htm)



## AreaStrainShellLayered

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaStrainShellLayered.htm`*
...
[AreaStrainShell](AreaStrainShell.htm)



## AreaStressPlane

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaStressPlane.htm`*
...
      ret = SapModel.Results.AreaStressPlane("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, S11, S22, S33, S12, SMax, SMin, SAngle, SVM)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaStressShell.htm`*
...
      ret = SapModel.Results.AreaStressShell("1", Object, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, S11Top, S22Top, S12Top, SMaxTop, SMinTop, SAngleTop, SVMTop, S11Bot, S22Bot, S12Bot, SMaxBot, SMinBot, SAngleBot, SVMBot, S13Avg, S23Avg, SMaxAvg, SAngleAvg)
...
[AreaJointForceShell](AreaJointForceShell.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AreaStressShellLayered.htm`*
...
The area element internal S11, S22 and S12 stresses, at the specified point element location, for the specified layer and layer integration point, reported in the area element local coordinate system. [F/L2]

SMax, SMin

The area element maximum and minimum principal stresses, at the specified point element location, for the specified layer and layer integration point. [F/L2]
...
The area element average S13 or S23 out-of-plane shear stress at the specified point element location, for the specified layer and layer integration point. [F/L2]
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/AssembledJointMass_1.htm`*

# AssembledJointMass\_1

## Syntax

SapObject.SapModel.Results.AssembledJointMass\_1

## VB6 Procedure

Function AssembledJointMass\_1(ByVal MassSourceName As
...
See [Type for Elements](Item_Type_for_Elements.htm)
...
See [Analysis
Results Remarks](Analysis_Results_Remarks.htm) for more information.
...
      ret = SapModel.Results.AssembledJointMass\_1("","ALL",
...
This function supersedes [AssembledJointMass](../../Obsolete_Functions/AssembledJointMass.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/BaseReact.htm`*
...
Function BaseReact(ByRef NumberResults As Long, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef Fx() As Double, ByRef Fy() As Double, ByRef Fz() As Double, ByRef Mx() As Double, ByRef My() As Double, ByRef Mz() As Double, ByRef gx as Double, ByRef gy as Double, ByRef gz as Double) As Long
...
See [Analysis Results Remarks](Analysis_Results_Remarks.htm) for additional information.
...
   'get base reactions
      ret = SapModel.Results.BaseReact(NumberResults, LoadCase, StepType, StepNum, Fx, Fy, Fz, Mx, My, Mz, gx, gy, gz)
...
[BaseReactWithCentroid](BaseReactWithCentroid.htm)

[GetJointReact](JointReact.htm)



## BaseReactWithCentroid

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/BaseReactWithCentroid.htm`*
...
These are arrays of the global X, Y and Z coordinates, respectively, of the centroid of all global X-direction translational reaction forces for each result. See [Base Reaction Centroids](Base_Reaction_Centroids.htm) for more information. [L]

XCentroidForFy, YCentroidForFy, ZCentroidForFy

These are arrays of the global X, Y and Z coordinates, respectively, of the centroid of all global Y-direction translational reaction forces for each result. See [Base Reaction Centroids](Base_Reaction_Centroids.htm) for more information. [L]

XCentroidForFz, YCentroidForFz, ZCentroidForFz

These are arrays of the global X, Y and Z coordinates, respectively, of the centroid of all global Z-direction translational reaction forces for each result. See [Base Reaction Centroids](Base_Reaction_Centroids.htm) for more information. [L]
...
Note that the reported base reaction centroids are not the same as the centroid of the applied loads. See [Base Reaction Centroids](Base_Reaction_Centroids.htm) for additional information.
...
[BaseReact](BaseReact.htm)

[JointReact](JointReact.htm)



## Base Reaction Centroids

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/Base_Reaction_Centroids.htm`*
...
**Important Note:** The base reaction centroids are calculated from translational reaction forces only. Reaction moments are not considered when calculating these centroids. Thus the reported base reaction centroids are not the same as the centroid of the applied loads.

Three centroid locations are reported: one for the X direction translational reactions, one for the Y direction translational reactions, and one for the Z direction translational reactions.
...
Following are descriptions of each coordinate item.

XCentroidForFx

This is an array of the X coordinates of the centroid of all X-direction translational reaction forces for each result. [L]

This item is reported as zero if the sum of all translational reaction forces in the X- direction is zero.

YCentroidForFx

This is an array of the Y coordinates of the centroid of all X-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the Y coordinate about which the Mz moment caused by the X-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the X-direction is zero.

ZCentroidForFx

This is an array of the Z coordinates of the centroid of all X-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the Z coordinate about which the My moment caused by the X-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the X-direction is zero.

XCentroidForFy

This is an array of the X coordinates of the centroid of all Y-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the X coordinate about which the Mz moment caused by the Y-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the Y-direction is zero.

YCentroidForFy

This is an array of the Y coordinates of the centroid of all Y-direction translational reaction forces for each result. [L]

This item is reported as zero if the sum of all translational reaction forces in the Y-direction is zero.

ZCentroidForFy

This is an array of the Z coordinates of the centroid of all Y-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the Z coordinate about which the Mx moment caused by the Y-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the Y-direction is zero.

XCentroidForFz

This is an array of the X coordinates of the centroid of all Z-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the X coordinate about which the My moment caused by the Z-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the Z-direction is zero.

YCentroidForFz

This is an array of the Y coordinates of the centroid of all Z-direction translational reaction forces for each result. [L]

Said another way, the coordinate in this array is the Y coordinate about which the Mx moment caused by the Z-direction translational reaction forces is zero.

This item is reported as zero if the sum of all translational reaction forces in the Z-direction is zero.

ZCentroidForFz

This is an array of the Z coordinates of the centroid of all Z-direction translational reaction forces for each result. [L]
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/BridgeSuperCutLongitStress.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/BucklingFactor.htm`*
...
This is an array that includes the step type for each result. For buckling factors, the step type is always Mode. See [Analysis Results Step Type](Analysis_Results_Step_Type.htm).

StepNum

This is an array that includes the step number for each result. For buckling factors, the step number is always the buckling mode number. See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/FrameForce.htm`*
...
[FrameJointForce](FrameJointForce.htm)



## FrameJointForce

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/FrameJointForce.htm`*
...
      ret = SapModel.Results.FrameJointForce("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
[FrameForce](FrameForce.htm)



## GeneralizedDispl

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/GeneralizedDispl.htm`*
...
[JointDispl](JointDispl.htm)

[JointDisplAbs](JointDisplAbs.htm)



## Item Type for Elements

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/Item_Type_for_Elements.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointAcc.htm`*
...
See [Item Type for Elements](Item_Type_for_Elements.htm) for more information.
...
These are one dimensional arrays that include the translational acceleration in the point element local 1, 2 and 3 axes directions, respectively, for each result. [L/s2]

R1, R2, R3

These are one dimensional arrays that include the rotational acceleration about the point element local 1, 2 and 3 axes, respectively, for each result. [rad/s2]
...
[JointVel](JointVel.htm)

[JointVelAbs](JointVelAbs.htm)

[JointAccAbs](JointAccAbs.htm)

[GeneralizedDispl](GeneralizedDispl.htm)



## JointAccAbs

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointAccAbs.htm`*
...
Function JointAccAbs(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef U1() As Double, ByRef U2() As Double, ByRef U3() As Double, ByRef R1() As Double, ByRef R2() As Double, ByRef R3() As Double) As Long
...
      ret = SapModel.Results.JointAccAbs("22", ObjectElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointDispl.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointDisplAbs.htm`*
...
Function JointDisplAbs(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef U1() As Double, ByRef U2() As Double, ByRef U3() As Double, ByRef R1() As Double, ByRef R2() As Double, ByRef R3() As Double) As Long
...
      ret = SapModel.Results.JointDisplAbs("22", ObjectElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointReact.htm`*
...
Function JointReact(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef F1() As Double, ByRef F2() As Double, ByRef F3() As Double, ByRef M1() As Double, ByRef M2() As Double, ByRef M3() As Double) As Long
...
These are one dimensional arrays that include the reaction forces in the point element local 1, 2 and 3 axes directions, respectively, for each result. [F]

M1, M2, M3

These are one dimensional arrays that include the reaction moments about the point element local 1, 2 and 3 axes, respectively, for each result. [FL]
...
   'get joint reactions
      ret = SapModel.Results.JointReact("1", Element, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointRespSpec.htm`*
...
This is an array of the response quantity, as defined in each named set, for each result. The possible response quantities are spectral displacement [L], spectral velocity [L/s], pseudo spectral velocity [L/s], spectral acceleration [L/s2], or pseudo spectral acceleration [L/s2].
...
[SetJointRespSpec](../../Definitions/Named_Sets/SetJointRespSpec.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointVel.htm`*
...
Function GJointVel(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef U1() As Double, ByRef U2() As Double, ByRef U3() As Double, ByRef R1() As Double, ByRef R2() As Double, ByRef R3() As Double) As Long
...
      ret = SapModel.Results.JointVel("22", ObjectElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/JointVelAbs.htm`*
...
      ret = SapModel.Results.JointVelAbs("22", ObjectElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/LinkDeformation.htm`*
...
Function LinkDeformation(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef U1() As Double, ByRef U2() As Double, ByRef U3() As Double, ByRef R1() As Double, ByRef R2() As Double, ByRef R3() As Double) As Long
...
These are one dimensional arrays that include the internal translational deformation of the link in the link element local axes directions. [L]

R1, R2, R3

These are one dimensional arrays that include the internal rotational deformation of the link about the link element local axes. [rad]
...
      ret = SapModel.Results.LinkDeformation("1", ObjectElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
[LinkForce](LinkForce.htm)

[LinkJointForce](LinkJointForce.htm)



## LinkForce

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/LinkForce.htm`*
...
[LinkDeformation](LinkDeformation.htm)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/LinkJointForce.htm`*
...
      ret = SapModel.Results.LinkJointForce("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/ModalLoadParticipationRatios.htm`*
...
[ModeShape](ModeShape.htm)

[ModalPeriod](ModalPeriod.htm)

[ModalParticipatingMassRatios](ModalParticipatingMassRatios.htm)

[ModalParticipationFactors](ModalParticipationFactors.htm)



## ModalParticipatingMassRatios

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/ModalParticipatingMassRatios.htm`*
...
This is an array that includes the step type, if any, for each result. For modal results, this will always be Mode.See [Analysis Results Step Type](Analysis_Results_Step_Type.htm).

StepNum

This is an array that includes the step number for each result. For modal results, this is always the mode number. See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
...
[ModalLoadParticipationRatios](ModalLoadParticipationRatios.htm)



## ModalParticipationFactors

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/ModalParticipationFactors.htm`*
...
This is an array that includes the step number for each result. For modal results, this will always be the mode number.  See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
...
This is an array that includes the modal participation factor for the structure Ux degree of freedom. The factor applies to the specified mode. [Fs2]

Uy

This is an array that includes the modal participation factor for the structure Uy degree of freedom. The factor applies to the specified mode. [Fs2]

Uz

This is an array that includes the modal participation factor for the structure Uz degree of freedom. The factor applies to the specified mode. [Fs2]

Rx

This is an array that includes the modal participation factor for the structure Rx degree of freedom. The factor applies to the specified mode. [FLs2]

Ry

This is an array that includes the modal participation factor for the structure Ry degree of freedom. The factor applies to the specified mode. [FLs2]

Rz

This is an array that includes the modal participation factor for the structure Rz degree of freedom. The factor applies to the specified mode. [FLs2]
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/ModalPeriod.htm`*
...
This is an array that includes the step type, if any, for each result. For modal results this is always be Mode. See [Analysis Results Step Type](Analysis_Results_Step_Type.htm).
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/ModeShape.htm`*
...
This is an array that includes the step type, if any, for each result. For mode shape results, this is always be Mode. See [Analysis Results Step Type](Analysis_Results_Step_Type.htm).

StepNum

This is an array that includes the step number for each result. For mode shape results, this is always the mode number. See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/PanelZoneDeformation.htm`*
...
Function PanelZoneDeformation(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Elm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef U1() As Double, ByRef U2() As Double, ByRef U3() As Double, ByRef R1() As Double, ByRef R2() As Double, ByRef R3() As Double) As Long
...
These are one dimensional arrays that include the internal translational deformation of the panel zone (link) in the link element local axes directions. [L]

R1, R2, R3

These are one dimensional arrays that include the internal rotational deformation of the panel zone (link) about the link element local axes. [rad]
...
      ret = SapModel.Results.PanelZoneDeformation("3", ObjectElm, NumberResults, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
...
[PanelZoneForce](PanelZoneForce.htm)



## PanelZoneForce

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/PanelZoneForce.htm`*
...
      ret = SapModel.Results.PanelZoneForce("3", ObjectElm, NumberResults, Elm, PointElm, LoadCase, StepType, StepNum, P, V2, V3, T, M2, M3)
...
[PanelZoneDeformation](PanelZoneDeformation.htm)



## SectionCutAnalysis

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/SectionCutAnalysis.htm`*
...
[SectionCutDesign](SectionCutDesign.htm)



## SectionCutDesign

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/SectionCutDesign.htm`*
...
[SectionCutAnalysis](SectionCutAnalysis.htm)



## SolidJointForce

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/SolidJointForce.htm`*
...
Function SolidJointForce(ByVal Name As String, ByVal ItemTypeElm As eItemTypeElm, ByRef NumberResults As Long, ByRef Obj() As String, ByRef Elm() As String, ByRef PointElm() As String, ByRef LoadCase() As String, ByRef StepType() As String, ByRef StepNum() As Double, ByRef F1() As Double, ByRef F2() As Double, ByRef F3() As Double, ByRef M1() As Double, ByRef M2() As Double, ByRef M3() As Double) As Long
...
      ret = SapModel.Results.SolidJointForce("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, F1, F2, F3, M1, M2, M3)
...
[SolidStress](SolidStress.htm)



## SolidStrain

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/SolidStrain.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/SolidStress.htm`*
...
      ret = SapModel.Results.SolidStress("1", ObjectElm, NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum, S11, S22, S33, S12, S13, S23, SMax, SMid, SMin, SVM, DirCosMax1, DirCosMax2, DirCosMax3, DirCosMid1, DirCosMid2, DirCosMid3, DirCosMin1, DirCosMin2, DirCosMin3)
...
[SolidJointForce](SolidJointForce.htm)



## StepLabel

*Source file: `SAP2000_API_Fuctions/Analysis_Results/Results/StepLabel.htm`*
...
This is an overall step number from the specified load case. The range of values of StepNum for a given load case can be obtained from most analysis results calls, such as SapObject.SapModel.Results.JointDispl. See [Analysis Results Step Number](Analysis_Results_Step_Number.htm).
