...
def orientAreaAxisSAP2000(SapModel,Area_label,Plane):
    """
    This function orient the axes of an area object along the 31 or 32 plane.
    Input:
        SapModel: SAP Model object
        Area_label: Label of the area object (string)
        Plane: This is 31 or 32 (integer), indicating that the local plane determined by the plane reference vector is the 3-1 plane or the 3-2 plane
    ...
    SapModel.AreaObj.SetLocalAxesAdvanced(Area_label, True, Plane, 2, 'Global', [3,1], MyPlPt, [0,0,0])
