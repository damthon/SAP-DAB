...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Definitions/Functions

---



## ChangeName {Functions}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/ChangeName_{Functions}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/ConvertToUser.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Count_{Functions}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Delete_{Functions}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/GetNameList_{Functions}.htm`*
...
Function GetNameList(ByRef NumberNames As Long, ByRef MyName() As String, Optional ByVal FuncType As Long = 0) As Long
...
This is a one-dimensional array of function names. The MyName array is created as a dynamic, zero-based array by the API user:
...
This is one of the following numbers, indicating the type of function for which the name list is desired.
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/GetType_{Functions}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/GetValues.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Power_Spectral_Density/GetFromFile_{PSD}.htm`*
...
      ret = SapModel.Func.FuncPSD.SetFromFile("PSD-1", "C:\SapAPI\FuncPSD.txt", 2, 0, 1, 2, True)

   'get PSD function from file
      ret = SapModel.Func.FuncPSD.GetFromFile("PSD-1", FileName, HeadLines, PreChars, PointsPerLine, ValueType, FreeFormat, NumberFixed, FreqTypeInFile)
...
[SetFromFile](SetFromFile_{PSD}.htm)



## GetUser {PSD}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Power_Spectral_Density/GetUser_{PSD}.htm`*
...
Function GetUser(ByVal Name As String, ByRef NumberItems As Long, ByRef Frequency() As Double, ByRef Value() As Double) As Long
...
[SetUser](SetUser_{PSD}.htm)



## SetFromFile {PSD}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Power_Spectral_Density/SetFromFile_{PSD}.htm`*
...
[GetFromFile](GetFromFile_{PSD}.htm)



## SetUser {PSD}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Power_Spectral_Density/SetUser_{PSD}.htm`*
...
[GetUser](GetUser_{PSD}.htm)



## GetAASHTO2006

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetAASHTO2006.htm`*
...
[SetAASHTO2006](SetAASHTO2006.htm)



## GetAASHTO2007

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetAASHTO2007.htm`*
...
[SetAASHTO2007](SetAASHTO2007.htm)



## GetAS11702007 (RS)

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetAS11702007_(RS).htm`*
...
[SetAS11702007](SetAS11702007.htm)



## GetBOCA96 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetBOCA96_{RS}.htm`*
...
[SetBOCA96](SetBOCA96_{RS}.htm)



## GetCJJ1662011 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetCJJ1662011_{RS}.htm`*
...
Function GetCJJ1662011(ByVal Name As String, ByRef Direction As Integer, ByRef PeakAccel As Double, ByRef Tg As Double, ByRef DampRatio As Double) As Long
...
[SetCJJ1662011](SetCJJ1662011.htm)



## GetChinese2010 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetChinese2010_{RS}.htm`*
...
[SetChinese2010](SetChinese2010_{RS}.htm)



## GetEuroCode8

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetEuroCode8.htm`*
...
      ret = SapModel.Func.FuncRS.SetEurocode82004\_1("RS-1", 1, 1, 1, 2, 0.4, 1.2, 0.9, 0.15, 0.5, 2, 0.2, 2, 0.04)

   'get Eurocode 8 2004 RS function
      ret = SapModel.Func.FuncRS.GetEurocode82004\_1("RS-1", EURO2004Country, EURO2004Direction, EURO2004SpectrumType, EURO2004GroundType, EURO2004ag, EURO2004S, EURO2004AvgoverAg, EURO2004Tb, EURO2004Tc, EURO2004Td, EURO2004Beta, EURO2004q, DampRatio)
...
This function supersedes [GetEurocode82004](../../../Obsolete_Functions/GetEurocode82004_(RS).htm).
...
[SetEurocode82004\_1](SetEurocode82004_1_{RS}.htm)



## GetFromFile {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetFromFile_{RS}.htm`*
...
[SetFromFile](SetFromFile_{RS}.htm)



## GetIBC2003 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetIBC2003_{RS}.htm`*
...
[SetIBC2003](SetIBC2003_{RS}.htm)



## GetIBC2006 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetIBC2006_{RS}.htm`*
...
[SetIBC2006](SetIBC2006_{RS}.htm)



## GetIS18932002 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetIS18932002_{RS}.htm`*
...
[SetIS18932002](SetIS18932002_{RS}.htm)



## GetItalian3274

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetItalian3274.htm`*
...
[SetItalian3274](SetItalian3274.htm)



## GetJTGB022013 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetJTGB022013.htm`*
...
[SetJTBG022013](SetJTBG022013.htm)



## GetJTGT223101_2020 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetJTGT223101_2020_{RS}.htm`*
...
Function GetJTGT2231012020(ByVal Name As String, ByRef
PeakAccel As Double, ByRef Tg As Double, ByRef Ci As Double, ByRef Cs
As Double, ByRef DampRatio As Double) As Long
...
      ret = SapModel.Func.FuncRS.GetJTGT2231012020("RS-1",
...
[SetJTGT2231012020](SetJTGT223101_2020_{RS}.htm)



## GetNBCC2005 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNBCC2005_{RS}.htm`*
...
[SetNBCC2005](SetNBCC2005_{RS}.htm)



## GetNBCC2010 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNBCC2010_{RS}.htm`*
...
Function GetNBCC2010(ByVal Name As String, ByRef PGA As Double, ByRef S02 As Double, ByRef S05 As Double, ByRef S1 As Double, ByRef S2 As Double, ByRef SiteClass As Long, ByRef Fa As Double, ByRef Fv As Double, ByRef DampRatio As Double) As Long
...
      ret = SapModel.Func.FuncRS.GetNBCC2010("RS-1", PGA, S02, S05, S1, S2, SiteClass, Fa, Fv, DampRatio)
...
[SetNBCC2010](SetNBCC2010_{RS}.htm)



## GetNBCC2015 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNBCC2015_{RS}.htm`*
...
Function GetNBCC2015(ByVal Name As String, ByRef PGA As Double, ByRef S02 As Double, ByRef S05 As Double, ByRef S1 As Double, ByRef S2 As Double, ByRef S5 As Double, ByRef S10 As Double, ByRef SiteClass As Long, ByRef F02 As Double, ByRef F05 As Double, ByRef F1 As Double, ByRef F2 As Double, ByRef F5 As Double, ByRef F10 As Double, ByRef DampRatio As Double) As Long
...
      ret = SapModel.Func.FuncRS.GetNBCC2015("RS-1", PGA, S02, S05, S1, S2, S5, S10, SiteClass, F02, F05, F1, F2, F5, F10, DampRatio)
...
[SetNBCC2015](SetNBCC2015_{RS}.htm)



## GetNBCC95 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNBCC95_{RS}.htm`*
...
[SetNBCC95](SetNBCC95_{RS}.htm)



## GetNCHRP2007

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNCHRP2007.htm`*
...
[SetNCHRP2007](SetNCHRP2007.htm)



## GetNEHRP97 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNEHRP97_{RS}.htm`*
...
Function GetNEHRP97(ByVal Name As String, ByRef NEHRP97SS As Double, ByRef NEHRP97S1 As Double, ByRef DampRatio As Double) As Long
...
      ret = SapModel.Func.FuncRS.GetNEHRP97("RS-1", NEHRP97SS, NEHRP97S1, DampRatio)
...
[SetNEHRP97](GetNEHRP97_{RS}.htm)



## GetNTC2008 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNTC2008_{RS}.htm`*
...
Function GetNTC2008(ByVal Name As String, ByRef ParamsOption As Long, ByRef Latitude As Double, ByRef Longitude As Double, ByRef Island As Long, ByRef LimitState As Long, ByRef UsageClass As Long, ByRef NomLife As Double, ByRef PeakAccel As Double, ByRef F0 As Double, ByRef Tcs As Double, ByRef SpecType As Long, ByRef SoilType As Long, ByRef Topography As Long, ByRef hRatio As Double, ByRef Damping As Double, ByRef q As Double) As Long
...
[SetNTC2008](SetNTC2008_{RS}.htm)



## GetNTC2018 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNTC2018_{RS}.htm`*
...
[SetNTC2018](SetNTC2018_{RS}.htm)



## GetNZS11702004_1

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNZS11702004_1.htm`*

# GetNZS11702004\_1

## Syntax

SapObject.SapModel.Func.FuncRS.GetNZS11702004\_1

## VB6 Procedure

Function GetNZS11702004\_1(ByVal Name As String, ByRef NZS2004SpectrumType As Long, ByRef NZS2004SiteClass As Long, ByRef NZS2004Z As Double, ByRef NZS2004R As Double, ByRef NZS2004DIST As Double, ByRef NZS2004ConsiderTSite As Boolean, ByRef NZS2004TSite As Double, ByRef DampRatio As Double) As Long
...
      ret = SapModel.Func.FuncRS.SetNZS11702004\_1("RS-1", 1, 3, 0.4, 1.3, 20, True, 1, 0.04)

   'get NZS 1170 2004 RS function
      ret = SapModel.Func.FuncRS.GetNZS11702004\_1("RS-1", NZS2004SpectrumType, NZS2004SiteClass, NZS2004Z, NZS2004R, NZS2004DIST, NZS2004ConsiderTSite, NZS2004TSite, DampRatio)
...
This function supersedes [GetNZS11702004](../../../Obsolete_Functions/GetNZS11702004.htm)

## See Also

[SetNZS11702004\_1](SetNZS11702004_1.htm)



## GetNZS42031992

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetNZS42031992.htm`*
...
[SetNZS42031992](SetNZS42031992.htm)



## GetSP14133302014 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetSP14133302014.htm`*
...
The nonlinear soil deformation factor, 0 > a\_soil <= 1.0. This is only applicable when the NonlinSoil parameter is True, the Direction parameter is 1 or 2 buildings, and the SoilCat parameter is 3 or 4.
...
[SetSP14133302014](SetSP14133302014.htm)



## GetUBC94 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetUBC94_{RS}.htm`*
...
Function GetUBC94(ByVal Name As String, ByRef UBC94Z As Double, ByRef UBC94S As Long, ByRef DampRatio As Double) As Long
...
[SetUBC94](SetUBC94_{RS}.htm)



## GetUBC97 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetUBC97_{RS}.htm`*
...
Function GetUBC97(ByVal Name As String, ByRef UBC97Ca As Double, ByRef UBC97Cv As Double, ByRef DampRatio As Double) As Long
...
[SetUBC97](GetUBC97_{RS}.htm)



## GetUser {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/GetUser_{RS}.htm`*
...
Function GetUser(ByVal Name As String, ByRef NumberItems As Long, ByRef Period() As Double, ByRef Value() As Double, ByRef DampRatio As Double) As Long
...
[SetUser](SetUser_{RS}.htm)



## SetAASHTO2006

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetAASHTO2006.htm`*
...
Function SetAASHTO2006(ByVal Name As String, ByVal AASHTO2006A As Double, ByVal AASHTO2006SoilProfileType As Long, ByVal DampRatio As Double) As Long
...
[GetAASHTO2006](GetAASHTO2006.htm)



## SetAASHTO2007

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetAASHTO2007.htm`*
...
[GetAASHTO2007](GetAASHTO2007.htm)



## SetAS11702007

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetAS11702007.htm`*
...
[GetAS11702007](GetAS11702007_(RS).htm)



## SetBOCA96 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetBOCA96_{RS}.htm`*
...
Function SetBOCA96(ByVal Name As String, ByVal BOCA96Aa As Double, ByVal BOCA96Av As Double, ByVal BOCA96S As Double, ByVal BOCA96R As Double, ByVal DampRatio As Double) As Long
...
[GetBOCA96](GetBOCA96_{RS}.htm)



## SetCJJ1662011 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetCJJ1662011.htm`*
...
[GetCJJ1662011](GetCJJ1662011_{RS}.htm)



## SetChinese2010 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetChinese2010_{RS}.htm`*
...
[GetChinese2010](GetChinese2010_{RS}.htm)



## SetEuroCode8

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetEuroCode8.htm`*
...
Function SetEuroCode8(ByVal Name As String, ByVal EuroCode8AG As Double, ByVal EuroCode8S As Long, ByVal EuroCode8n As Double, ByVal DampRatio As Double) As Long
...
[GetEuroCode8](GetEuroCode8.htm)



## SetEurocode82004_1 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetEurocode82004_1_{RS}.htm`*

# SetEurocode82004\_1

## Syntax

SapObject.SapModel.Func.FuncRS.SetEurocode82004\_1

## VB6 Procedure

Function SetEurocode82004\_1(ByVal Name As String, ByVal EURO2004Country As Long, ByVal EURO2004Direction As Long, ByVal EURO2004SpectrumType As Long, ByVal EURO2004GroundType As Long, ByVal EURO2004ag As Double, ByVal EURO2004S As Double, ByVal EURO2004AvgoverAg As Double, ByVal EURO2004Tb As Double, ByVal EURO2004Tc As Double, ByVal EURO2004Td As Double, ByVal EURO2004Beta As Double, ByVal EURO2004q As Double, ByVal DampRatio As Double) As Long
...
The soil factor, S. This item only applies when the EURO2004Direction item is 1 (horizontal).  If the EURO2004Country item is not 0, then the input value for this item is ignored.

EURO2004AvgoverAg

The vertical ground acceleration divided by the horizontal ground acceleration, Avg/Ag. This item only applies when the EURO2004Direction item is 2 (vertical).  If the EURO2004Country item is not 0, then the input value for this item is ignored.

EURO2004Tb

The lower limit of period of the constant spectral acceleration branch, Tb. If the EURO2004Country item is not 0, then the input value for this item is ignored.

EURO2004Tc

The upper limit of period of the constant spectral acceleration branch, Tc. If the EURO2004Country item is not 0, then the input value for this item is ignored.

EURO2004Td

The period defining the start of the constant displacement range, Td. If the EURO2004Country item is not 0, then the input value for this item is ignored.

EURO2004Beta

The lower bound factor, Beta. If the EURO2004Country item is not 0, then the input value for this item is ignored.
...
This function supersedes [SetEurocode82004](../../../Obsolete_Functions/SetEurocode82004_{RS}.htm).
...
[GetEurocode82004\_1](GetEurocode82004_1_{RS}.htm)



## SetFromFile {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetFromFile_{RS}.htm`*
...
[GetFromFile](GetFromFile_{RS}.htm)



## SetIBC2003 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetIBC2003_{RS}.htm`*
...
Function SetIBC2003(ByVal Name As String, ByVal IBC2003SS As Double, ByVal IBC2003S1 As Double, ByVal DampRatio As Double) As Long
...
[GetIBC2003](GetIBC2003_{RS}.htm)



## SetIBC2006 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetIBC2006_{RS}.htm`*
...
[GetIBC2006](GetIBC2006_{RS}.htm)



## SetIS18932002 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetIS18932002_{RS}.htm`*
...
Function SetIS18932002(ByVal Name As String, ByVal INZ As Double, ByVal INS As Long, ByVal DampRatio As Double) As Long
...
[GetIS18932002](GetIS18932002_{RS}.htm)



## SetItalian3274

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetItalian3274.htm`*
...
Function SetItalian3274(ByVal Name As String, ByVal Italag As Double, ByVal ItalSoilType As Long, ByVal Italq As Double, ByVal ItalLevel As Double, ByVal DampRatio As Double) As Long
...
[GetItalian3274](GetItalian3274.htm)



## SetJTBG022013 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetJTBG022013.htm`*
...
Function SetJTGB022013(ByVal Name As String, ByVal Direction As Long, ByVal PeakAccel As Double, ByVal Tg As Double, ByVal Ci As Double, ByVal Cs As Double, ByVal DampRatio As Double) As Long
...
[GetJTBG022013](GetJTGB022013.htm)



## SetJTGT223101_2020 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetJTGT223101_2020_{RS}.htm`*
...
[GetJTGT2231012020](GetJTGT223101_2020_{RS}.htm)



## SetNBCC2005 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNBCC2005_{RS}.htm`*
...
Function SetNBCC2005(ByVal Name As String, ByVal NBCC2005PGA As Double, ByVal NBCC2005S02 As Double, ByVal NBCC2005S05 As Double, ByVal NBCC2005S1 As Double, ByVal NBCC2005S2 As Double, ByVal NBCC2005SiteClass As Long, ByVal NBCC2005Fa As Double, ByVal NBCC2005Fv As Double, ByVal DampRatio As Double) As Long
...
[GetNBCC2005](GetNBCC2005_{RS}.htm)



## SetNBCC2010 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNBCC2010_{RS}.htm`*
...
Function SetNBCC2010(ByVal Name As String, ByVal PGA As Double, ByVal S02 As Double, ByVal S05 As Double, ByVal S1 As Double, ByVal S2 As Double, ByVal SiteClass As Long, ByVal Fa As Double, ByVal Fv As Double, ByVal DampRatio As Double) As Long
...
[GetNBCC2010](GetNBCC2010_{RS}.htm)



## SetNBCC2015 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNBCC2015_{RS}.htm`*
...
[GetNBCC2015](GetNBCC2015_{RS}.htm)



## SetNBCC95 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNBCC95_{RS}.htm`*
...
Function SetNBCC95(ByVal Name As String, ByVal NBCC95ZVR As Double, ByVal NBCC95ZA As Long, ByVal NBCC95ZV As Long, ByVal DampRatio As Double) As Long
...
[GetNBCC95](GetNBCC95_{RS}.htm)



## SetNCHRP2007

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNCHRP2007.htm`*
...
[GetNCHRP2007](GetNCHRP2007.htm)



## SetNEHRP97 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNEHRP97_{RS}.htm`*
...
[GetNEHRP97](GetNEHRP97_{RS}.htm)



## SetNTC2008 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNTC2008_{RS}.htm`*
...
Function SetNTC2008(ByVal Name As String, ByVal ParamsOption As Long, ByVal Latitude As Double, ByVal Longitude As Double, ByVal Island As Long, ByVal LimitState As Long, ByVal UsageClass As Long, ByVal NomLife As Double, ByVal PeakAccel As Double, ByVal F0 As Double, ByVal Tcs As Double, ByVal SpecType As Long, ByVal SoilType As Long, ByVal Topography As Long, ByVal hRatio As Double, ByVal Damping As Double, ByVal q As Double) As Long
...
[GetNTC2008](GetNTC2008_{RS}.htm)



## SetNTC2018 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNTC2018_{RS}.htm`*
...
[GetNTC2018](GetNTC2018_{RS}.htm)



## SetNZS11702004_1

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNZS11702004_1.htm`*

# SetNZS11702004\_1

## Syntax

SapObject.SapModel.Func.FuncRS.SetNZS11702004\_1

## VB6 Procedure

Function SetNZS11702004\_1(ByVal Name As String, ByRef NZS2004SpectrumType As Long, ByVal NZS2004SiteClass As Long, ByVal NZS2004Z As Double, ByVal NZS2004R As Double, ByVal NZS2004DIST As Double, ByVal NZS2004ConsiderTSite As Boolean, ByVal NZS2004TSite As Double, ByVal DampRatio As Double) As Long
...
This function supersedes [SetNZS11702004](../../../Obsolete_Functions/SetNZS11702004.htm)

## See Also

[GetNZS11702004\_1](GetNZS11702004_1.htm)



## SetNZS42031992

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetNZS42031992.htm`*
...
Function SetNZS42031992(ByVal Name As String, ByVal NZS4203SF As Double, ByVal NZS4203S As Long, ByVal DampRatio As Double) As Long
...
[GetNZS42031992](GetNZS42031992.htm)



## SetSP14133302014 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetSP14133302014.htm`*
...
[GetSP14133302014](GetSP14133302014.htm)



## SetUBC94 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetUBC94_{RS}.htm`*
...
Function SetUBC94(ByVal Name As String, ByVal UBC94Z As Double, ByVal UBC94S As Long, ByVal DampRatio As Double) As Long
...
[GetUBC94](GetUBC94_{RS}.htm)



## SetUBC97 {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetUBC97_{RS}.htm`*
...
Function SetUBC97(ByVal Name As String, ByVal UBC97Ca As Double, ByVal UBC97Cv As Double, ByVal DampRatio As Double) As Long
...
[GetUBC97](GetUBC97_{RS}.htm)



## SetUser {RS}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Response_Spectrum/SetUser_{RS}.htm`*
...
[GetUser](GetUser_{RS}.htm)



## GetFromFile {Steady State}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Steady_State/GetFromFile_{Steady_State}.htm`*
...
[SetFromFile](SetFromFile_{Steady_State}.htm)



## GetUser {Steady State}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Steady_State/GetUser_{Steady_State}.htm`*
...
[SetUser](SetUser_{Steady_State}.htm)



## SetFromFile {Steady State}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Steady_State/SetFromFile_{Steady_State}.htm`*
...
[GetFromFile](GetFromFile_{Steady_State}.htm)



## SetUser {Steady State}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Steady_State/SetUser_{Steady_State}.htm`*
...
[GetUser](GetUser_{Steady_State}.htm)



## GetCosine

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetCosine.htm`*
...
[SetCosine](SetCosine.htm)



## GetFromFile_1 {Time History}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetFromFile_1_{Time_History}.htm`*

# **GetFromFile\_1**

## Syntax

SapObject.SapModel.Func.FuncTH.GetFromFile\_1

## VB6 Procedure

Function GetFromFile\_1(ByVal Name As String, ByRef FileName As String, ByRef HeadLines As Long, ByRef PreChars As Long, ByRef PointsPerLine As Long, ByRef ValueType As Long, ByRef FreeFormat As Boolean, ByRef NumberFixed As Long, DT As Double) As Long
...
This item applies only when the ValueType item is 1 (equal time intervals). It is the time interval between function points.
...
      ret = SapModel.Func.FuncTH.SetFromFile\_1("TH-1", "C:\SapAPI\FuncTH.txt", 3, 0, 3, 2, True)

   'get TH function from file
      ret = SapModel.Func.FuncTH.GetFromFile\_1("TH-1", FileName, HeadLines, PreChars, PointsPerLine, ValueType, FreeFormat, NumberFixed, DT)
...
This function supersedes [GetFromFile.](../../../Obsolete_Functions/GetFromFile_{Time_History}.htm)

## See Also

[SetFromFile\_1](SetFromFile_1_{Time_History}.htm)



## GetRamp

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetRamp.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetSawtooth.htm`*
...
[SetSawtooth](SetSawtooth.htm)



## GetSine

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetSine.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetTriangular.htm`*
...
Function GetTriangular(ByVal Name As String, ByRef TriP As Double, ByRef TriCycles As Long, ByRef TriAmp As Double) As Long
...
[SetTriangular](SetTriangular.htm)



## GetUserPeriodic

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetUserPeriodic.htm`*
...
[SetUserPeriodic](SetUserPeriodic.htm)



## GetUser {Time History}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/GetUser_{Time_History}.htm`*
...
[SetUser](SetUser_{Time_History}.htm)



## SetCosine

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetCosine.htm`*
...
[GetCosine](GetCosine.htm)



## SetFromFile_1 {Time History}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetFromFile_1_{Time_History}.htm`*

# **SetFromFile\_1**

## Syntax

SapObject.SapModel.Func.FuncTH.SetFromFile\_1

## VB6 Procedure

Function SetFromFile\_1(ByVal Name As String, ByVal FileName As String, ByVal HeadLines As Long, ByVal PreChars As Long, ByVal PointsPerLine As Long, ByVal ValueType As Long, ByVal FreeFormat As Boolean, Optional ByVal NumberFixed As Long = 10, Optional ByVal DT As Double = 0.02) As Long
...
This function supersedes [SetFromFile](../../../Obsolete_Functions/SetFromFile_{Time_History}.htm).

## See Also

[GetFromFile\_1](GetFromFile_1_{Time_History}.htm)



## SetRamp

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetRamp.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetSawtooth.htm`*
...
[GetSawtooth](GetSawtooth.htm)



## SetSine

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetSine.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetTriangular.htm`*
...
Function SetTriangular(ByVal Name As String, ByVal TriP As Double, ByVal TriCycles As Long, ByVal TriAmp As Double) As Long
...
[GetTriangular](GetTriangular.htm)



## SetUserPeriodic

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetUserPeriodic.htm`*
...
Function SetUserPeriodic(ByVal Name As String, ByVal UPCycles As Long, ByVal NumberItems As Long, ByRef MyTime() As Double, ByRef Value() As Double) As Long
...
[GetUserPeriodic](GetUserPeriodic.htm)



## SetUser {Time History}

*Source file: `SAP2000_API_Fuctions/Definitions/Functions/Time_History/SetUser_{Time_History}.htm`*
...
[GetUser](GetUser_{Time_History}.htm)
