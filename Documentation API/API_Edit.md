...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Edit
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Area/ChangeConnectivity_{Area_Object}.htm`*
...
   'divide area object
      ret = SapModel.EditArea.Divide\_1("1", 1, NumberAreas, AreaName)
...
This function supersedes [Divide {Area Object}](../../Obsolete_Functions/Divide_{Area_Object}.htm)
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Area/ExpandShrink.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Area/Merge_{Area_Object}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Area/PointAdd.htm`*
...
[PointRemove](PointRemove.htm)



## PointRemove

*Source file: `SAP2000_API_Fuctions/Edit/Edit_Area/PointRemove.htm`*
...
[PointAdd](PointAdd.htm)



## ChangeConnectivity {Frame}

*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/ChangeConnectivity_{Frame}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/DivideAtDistance.htm`*
...
[DivideByRatio](DivideByRatio.htm)

[DivideAtIntersections](DivideAtIntersections.htm)



## DivideAtIntersections

*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/DivideAtIntersections.htm`*
...
[DivideAtDistance](DivideAtDistance.htm)



## DivideByRatio

*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/DivideByRatio.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/Extend.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/Join.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Frame/Trim.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Point/Align.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Point/ChangeCoordinates_1_{Point}.htm`*

# ChangeCoordinates\_1

## Syntax

SapObject.SapModel.EditPoint.ChangeCoordinates\_1

## VB6 Procedure

Function ChangeCoordinates\_1(ByVal Name As String, ByVal x As Double, ByVal y As Double, ByVal z As Double, Optional ByVal NoRefresh As Boolean = False) As Long
...
      ret = SapModel.EditPoint.ChangeCoordinates\_1("1", -288, 0, 36)
...
This function supersedes [ChangeCoordinates](../../Obsolete_Functions/ChangeCoordinates_{Point}.htm).
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Point/Connect.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Point/Disconnect.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Point/Merge_{Point_Function}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/Edit_Solid/Divide_{Solid_Object}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudeAreaToSolidLinearNormal.htm`*
...
Function ExtrudeAreaToSolidLinearNormal(ByVal Name As
String, ByVal PropName As String, ByVal nPlus3 As Long, ByVal tPlus3 As
Double, ByVal nMinus3 As Long, ByVal tMinus3 As Double, ByRef NumberSolids
As Long, ByRef SolidName() As String, Optional ByVal Remove As Boolean
= True) As Long
...
The number of solid objects created in the positive
local 3-axis direction of the specified area object.

tPlus3

The thickness of the solid objects created in the positive
local 3-axis direction of the specified area object.

nMinus3

The number of solid objects created in the negative
local 3-axis direction of the specified area object.

tMinus3

The thickness of the solid objects created in the negative
local 3-axis direction of the specified area object.
...
extruding a specified area object, in the local 3-axis direction of the
area object, into solid objects.
...
[ExtrudeAreaToSolidLinearUser](ExtrudeAreaToSolidLinearUser.htm)

[ExtrudeAreaToSolidRadial](ExtrudeAreaToSolidRadial.htm)



## ExtrudeAreaToSolidLinearUser

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudeAreaToSolidLinearUser.htm`*
...
[ExtrudeAreaToSolidLinearNormal](ExtrudeAreaToSolidLinearNormal.htm)
...
*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudeAreaToSolidRadial.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudeFrameToAreaLinear.htm`*
...
[ExtrudeFrameToAreaRadial](ExtrudeFrameToAreaRadial.htm)



## ExtrudeFrameToAreaRadial

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudeFrameToAreaRadial.htm`*
...
[ExtrudeFrameToAreaLinear](ExtrudeFrameToAreaLinear.htm)



## ExtrudePointToFrameLinear

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudePointToFrameLinear.htm`*
...
Function ExtrudePointToFrameLinear(ByVal Name As String,
ByVal PropName As String, ByVal dx As Double, ByVal dy As Double, ByVal
dz As Double, ByVal NumberFrames As Long, ByRef FrameName() As String)
As Long
...
These are the x, y and z offsets used, in the present
coordinate system, to create each new frame object.
...
This function creates new frame objects by linearly
...
[ExtrudePointToFrameRadial](ExtrudePointToFrameRadial.htm)



## ExtrudePointToFrameRadial

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ExtrudePointToFrameRadial.htm`*
...
[ExtrudePointToFrameLinear](ExtrudePointToFrameLinear.htm)



## Move

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/Move.htm`*
...
*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ReplicateLinear.htm`*
...
Function ReplicateLinear(ByVal dx As Double, ByVal dy
As Double, ByVal dz As Double, ByVal Number As Long, ByRef NumberObjects
As Long, ByRef ObjectName() As String, ByRef ObjectType() As Long, Optional
ByVal Remove As Boolean = False) As Long
...
These are the x, y and z offsets used, in the present
coordinate system, to replicate the selected objects.
...
[ReplicateRadial](ReplicateRadial.htm)

[ReplicateMirror](ReplicateMirror.htm)



## ReplicateMirror

*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ReplicateMirror.htm`*
...
[ReplicateLinear](ReplicateLinear.htm)
...
*Source file: `SAP2000_API_Fuctions/Edit/General_Edit/ReplicateRadial.htm`*
