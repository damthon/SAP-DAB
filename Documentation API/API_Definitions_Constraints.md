# API Definitions Constraints

Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Definitions/Constraints
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/ChangeName_{Constraints}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/Count_{Constraints}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/Delete_{Constraints}.htm`*
...
[SetDiaphragm](SetDiaphragm.htm)

[SetEqual](SetEqual.htm)

[SetLine](SetLine_{Constraints}.htm)

[SetLocal](SetLocal.htm)

[SetPlate](SetPlate_{Constraint}.htm)
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetBeam.htm`*
...
Function GetBeam(ByVal Name As String, ByRef Axis As eConstraintAxis, ByRef CSys As String) As Long
...
      If ConstraintType = CONSTRAINT\_BEAM Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetBody.htm`*
...
Function GetBody(ByVal Name As String, ByRef Value() As Boolean, ByRef CSys As String) As Long
...
      If ConstraintType = CONSTRAINT\_BODY Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetConstraintType.htm`*
...
[GetDiaphragm](GetDiaphragm.htm)

[GetEqual](GetEqual.htm)

[GetLine](GetLine_{Constraint}.htm)

[GetLocal](GetLocal.htm)

[GetPlate](GetPlate_{Constraint}.htm)
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetDiaphragm.htm`*
...
Function GetDiaphragm(ByVal Name As String, ByRef Axis As eConstraintAxis, ByRef CSys As String) As Long
...
   'get constraint data
      ret = SapModel.ConstraintDef.GetConstraintType("Diaph1", ConstraintType)
      If ConstraintType = CONSTRAINT\_DIAPHRAGM Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetEqual.htm`*
...
Function GetEqual(ByVal Name As String, ByRef Value() As Boolean, ByRef CSys As String) As Long
...
      If ConstraintType = CONSTRAINT\_EQUAL Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetLine_{Constraint}.htm`*
...
Function GetLine(ByVal Name As String, ByRef Value() As Boolean, ByRef CSys As String) As Long
...
      If ConstraintType = CONSTRAINT\_LINE Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetLocal.htm`*
...
      If ConstraintType = CONSTRAINT\_LOCAL Then
...
## GetNameList {Constraints}

*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetNameList_{Constraints}.htm`*
...
This is a one-dimensional array of joint constraint names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetPlate_{Constraint}.htm`*
...
      If ConstraintType = CONSTRAINT\_PLATE Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetRod.htm`*
...
Function GetRod(ByVal Name As String, ByRef Axis As eConstraintAxis, ByRef CSys As String) As Long
...
      If ConstraintType = CONSTRAINT\_ROD Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetSpecialRigidDiaphragmList.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/GetWeld.htm`*
...
      If ConstraintType = CONSTRAINT\_WELD Then
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetBeam.htm`*
...
Function SetBeam(ByVal Name As String, Optional ByVal Axis As eConstraintAxis = AutoAxis, Optional ByVal CSys As String = "Global") As Long
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetBody.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetDiaphragm.htm`*
...
Function SetDiaphragm(ByVal Name As String, Optional ByVal Axis As eConstraintAxis = AutoAxis, Optional ByVal CSys As String = "Global") As Long
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetEqual.htm`*
...
Function SetEqual(ByVal Name As String, ByRef Value() As Boolean, Optional ByVal CSys As String = "Global") As Long
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetLine_{Constraints}.htm`*
...
Function SetLine(ByVal Name As String, ByRef Value() As Boolean, Optional ByVal CSys As String = "Global") As Long
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetLocal.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetPlate_{Constraint}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetRod.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Constraints/SetWeld.htm`*
