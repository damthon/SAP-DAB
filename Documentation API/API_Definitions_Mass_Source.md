# API Definitions Mass Source

Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Definitions/Mass_Source
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/ChangeName_{MassSource}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Count_{MassSource}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Delete_{MassSource}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Get_Default_{MassSource}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Get_Mass_Source.htm`*
...
The number of load patterns specified for the mass source.  This item is only applicable when the MassFromLoads item is True.
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Get_Name_List.htm`*
...
This is a one-dimensional array of mass source names. The MyName array is created as a dynamic, zero-based, array by the API user:
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Set_Default.htm`*
...
*Source file: `SAP2000_API_Fuctions/Definitions/Mass_Source/Set_Mass_Source.htm`*
...
The mass source name. If a mass source with this name already exists then the mass source is reinitialized with the new data.  All previous data assigned to the mass source is lost. If a mass source with this name does not exist then a new mass source is added.
...
If this item is True then the mass source is the default mass source.  Only one mass source can be the default mass source so when this assignment is True all other mass sources are automatically set to have the IsDefault flag False.
