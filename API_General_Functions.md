...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/General_Functions
...
*Source file: `SAP2000_API_Fuctions/General_Functions/ApplicationExit.htm`*
...
   'initialize model
      ret = SapModel.InitializeNewModel(kip\_ft\_F)
...
[ApplicationStart](ApplicationStart.htm)



## ApplicationStart

*Source file: `SAP2000_API_Fuctions/General_Functions/ApplicationStart.htm`*
...
Function ApplicationStart(Optional ByVal Units As eUnits = kip\_in\_F, Optional ByVal Visible As Boolean = True, Optional ByVal FileName As String = "") As Long
...
[ApplicationExit](SetAsActiveObject.htm)

[OpenFile](../File/OpenFile.htm)

[InitializeNewModel](InitializeNewModel.htm)



## GetKeyStringsExtendedEntityData

*Source file: `SAP2000_API_Fuctions/General_Functions/Extended_Entity_Data/GetKeyStringsExtendedEntityData.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Extended_Entity_Data/GetKeysWithStringsExtendedEntityData.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Extended_Entity_Data/SetStringsExtendedEntityData.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/GetDatabaseUnits.htm`*
...
[SetPresentUnits](SetPresentUnits.htm)

[GetPresentUnits](GetPresentUnits.htm)



## GetMergeTol

*Source file: `SAP2000_API_Fuctions/General_Functions/GetMergeTol.htm`*
...
[SetMergeTol](SetMergeTol.htm)



## GetModelFilename

*Source file: `SAP2000_API_Fuctions/General_Functions/GetModelFilename.htm`*
...
   'save the model
      ret = SapModel.File.Save("C:\SapAPI\API\_1-001.sdb")
...
[GetModelFilepath](GetModelFilepath.htm)



## GetModelFilepath

*Source file: `SAP2000_API_Fuctions/General_Functions/GetModelFilepath.htm`*
...
[GetModelFilename](GetModelFilename.htm)



## GetModelIsLocked

*Source file: `SAP2000_API_Fuctions/General_Functions/GetModelIsLocked.htm`*
...
[SetModelIsLocked](SetModelIsLocked.htm)



## GetOAPIVersionNumber

*Source file: `SAP2000_API_Fuctions/General_Functions/GetOAPIVersionNumber.htm`*
...
[Helper.GetOAPIVersionNumber](Helper/GetOAPIVersionNumber.htm)



## GetPresentCoordSystem

*Source file: `SAP2000_API_Fuctions/General_Functions/GetPresentCoordSystem.htm`*
...
[SetPresentCoordSystem](SetPresentCoordSystem.htm)



## GetPresentUnits

*Source file: `SAP2000_API_Fuctions/General_Functions/GetPresentUnits.htm`*
...
[GetDatabaseUnits](GetDatabaseUnits.htm)



## GetProjectInfo

*Source file: `SAP2000_API_Fuctions/General_Functions/GetProjectInfo.htm`*
...
[SetProjectInfo](SetProjectInfo.htm)



## GetUserComment

*Source file: `SAP2000_API_Fuctions/General_Functions/GetUserComment.htm`*
...
[SetUserComment](SetUserComment.htm)



## GetVersion

*Source file: `SAP2000_API_Fuctions/General_Functions/GetVersion.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObject.htm`*
...
Set SapObject = myHelper.CreateObject("C:\Program
...
[SapObject.ApplicationStart](../ApplicationStart.htm)



## CreateObjectHost

*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObjectHost.htm`*
...
Function CreateObjectHost(ByVal hostName As String,
...
Set SapObject = myHelper.CreateObjectHost("RemoteServer",
"C:\Program Files\Computers and Structures\SAP2000 22\SAP2000.exe")
...
[RemoteAPI](../../../Remote_API.htm)



## CreateObjectHostPort

*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObjectHostPort.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObjectProgID.htm`*
...
Function CreateObjectProgID(ByVal progID As String)
As cOAPI
...
the full path to SAP2000.exe. The overriding environment variable is "CSI\_SAP2000\_API\_SapObject\_PATH"
for SAP2000 and "CSI\_CSiBridge\_API\_SapObject\_PATH" for CSiBridge.
...
Initial release in version 19.10
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObjectProgIDHost.htm`*
...
Function CreateObjectProgIDHost(ByVal hostName As String,
ByVal progID As String) As cOAPI
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/CreateObjectProgIDHostPort.htm`*
...
Function CreateObjectProgIDHostPort(ByVal hostName As
String, ByVal portNumber As Integer, ByVal progID As String) As cOAPI
...
Set SapObject = myHelper.CreateObjectProgIDHostPort("RemoteServer",
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/GetOAPIVersionNumber.htm`*
...
    'API
client uses a newer version of the API than SAP2000.

    'All
API functionality may be not be available.
...
Initial release in version 21.00

## See Also

[SapObject.GetOAPIVersionNumber](../GetOAPIVersionNumber.htm)



## GetObject

*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/GetObject.htm`*
...
[SapObject.AplicationExit](../ApplicationExit.htm)

[SetAsActiveObject](../SetAsActiveObject.htm)

[UnsetAsActiveObject](../UnsetAsActiveObject.htm)



## GetObjectHost

*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/GetObjectHost.htm`*
...
Function GetObjectHost(ByVal hostName As String, ByVal
...
Set SapObject = myHelper.GetObjectHost("RemoteServer",
"CSI.SAP2000.API.SapObject")
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/GetObjectHostPort.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Helper/GetObjectProcess.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Hide.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/InitializeNewModel.htm`*
...
Function InitializeNewModel(Optional ByVal Units As eUnits = kip\_in\_F) As Long
...
      SapModel.InitializeNewModel(kN\_m\_C)
...
*Source file: `SAP2000_API_Fuctions/General_Functions/SetAsActiveObject.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/SetMergeTol.htm`*
...
[GetMergeTol](GetMergeTol.htm)



## SetModelIsLocked

*Source file: `SAP2000_API_Fuctions/General_Functions/SetModelIsLocked.htm`*
...
[GetModelIsLocked](GetModelIsLocked.htm)



## SetPresentCoordSystem

*Source file: `SAP2000_API_Fuctions/General_Functions/SetPresentCoordSystem.htm`*
...
[GetPresentCoordSystem](GetPresentCoordSystem.htm)



## SetPresentUnits

*Source file: `SAP2000_API_Fuctions/General_Functions/SetPresentUnits.htm`*
...
      ret = SapModel.SetPresentUnits(KN\_m\_C)
...
*Source file: `SAP2000_API_Fuctions/General_Functions/SetProjectInfo.htm`*
...
[GetUserComment](GetUserComment.htm)



## SetUserComment

*Source file: `SAP2000_API_Fuctions/General_Functions/SetUserComment.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Unhide.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/UnsetAsActiveObject.htm`*
...
*Source file: `SAP2000_API_Fuctions/General_Functions/Visible.htm`*
