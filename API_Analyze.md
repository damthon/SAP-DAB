...
Source: CSI OAPI Documentation (SAP2000) — SAP2000_API_Fuctions/Analyze

---



## Analyze.GetSolverOption_3

*Source file: `SAP2000_API_Fuctions/Analyze/Analyze.GetSolverOption_3.htm`*

# GetSolverOption\_3

## Syntax

SapObject.SapModel.Analyze.GetSolverOption\_3

## VB6 Procedure

Function GetSolverOption\_3(ByRef SolverType As Long, ByRef SolverProcessType As Long, ByRef NumberParallelRuns As Long, ByRef ResponseFileSizeMaxMB As Long, ByRef NumberAnalysisThreads As Long, ByRef StiffCase As String) As Long
...
-8 to -2 = The negative of the program determined value when the assigned value is 0 = Auto parallel (use up to all physical cores - max 8).
1 = Serial.
...
      ret = SapModel.Analyze.GetSolverOption\_3(SolverType, SolverProcessType, NumberParallelRuns, ResponseFileSizeMaxMB, NumberAnalysisThreads, StiffCase)
...
Added ResponseFileSizeMaxMB and NumberAnalysisThreads parameters in v23.2.0

This function supersedes [GetSolverOption\_2](../Obsolete_Functions/NEW_-_Analyze.GetSolverOption_2.htm), adding the NumberParallelRuns parameter and removing the previous Force32BitSolver parameter

## See Also

[SetSolverOption\_3](Analyze.SetSolverOption_3.htm)



## Analyze.SetSolverOption_3

*Source file: `SAP2000_API_Fuctions/Analyze/Analyze.SetSolverOption_3.htm`*

# SetSolverOption\_3

## Syntax

SapObject.SapModel.Analyze.SetSolverOption\_3

## VB6 Procedure

Function SetSolverOption\_3(ByVal SolverType As Long, ByVal SolverProcessType As Long, ByVal NumberParallelRuns As Long, ByVal ResponseFileSizeMaxMB As Long, , ByVal NumberAnalysisThreads As Long, Optional ByVal StiffCase As String = "") As Long
...
   'set model solver options
      ret = SapModel.Analyze.SetSolverOption\_3(1, 1, 3, 0, 0 "DEAD")
...
This function supersedes [SetSolverOption\_2](../Obsolete_Functions/NEW_-_Analyze.SetSolverOption_2.htm), adding the NumberParallelRuns parameter and removing the previous Force32BitSolver parameter.

## See Also

[GetSolverOption\_3](Analyze.GetSolverOption_3.htm)



## CreateAnalysisModel

*Source file: `SAP2000_API_Fuctions/Analyze/CreateAnalysisModel.htm`*
...
[RunAnalysis](RunAnalysis.htm)



## DeleteResults {Analyze}

*Source file: `SAP2000_API_Fuctions/Analyze/DeleteResults_{Analyze}.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analyze/GetActiveDOF.htm`*
...
[SetActiveDOF](SetActiveDOF.htm)



## GetCaseStatus

*Source file: `SAP2000_API_Fuctions/Analyze/GetCaseStatus.htm`*
...
Function GetCaseStatus(ByRef NumberItems As Long, ByRef CaseName() As String, ByRef Status() As Long) As Long
...
*Source file: `SAP2000_API_Fuctions/Analyze/GetRunCaseFlag.htm`*
...
Function GetRunCaseFlag(ByRef NumberItems As Long, ByRef CaseName() As String, ByRef Run() As Boolean) As Long
...
[SetRunCaseFlag](SetRunCaseFlag.htm)



## MergeAnalysisResults

*Source file: `SAP2000_API_Fuctions/Analyze/MergeAnalysisResults.htm`*
...
ret = SapModel.Analyze.SetSolverOption\_2(1, 2, 0)
...
[File.Save](../File/Save.htm)

[Analyze.RunAnalysis](RunAnalysis.htm)

[Analyze.SetSolverOption\_2](../Obsolete_Functions/NEW_-_Analyze.SetSolverOption_2.htm)



## ModifyUnDeformedGeometry

*Source file: `SAP2000_API_Fuctions/Analyze/ModifyUnDeformedGeometry.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analyze/ModifyUndeformedGeometryModeShape.htm`*
...
*Source file: `SAP2000_API_Fuctions/Analyze/RunAnalysis.htm`*
...
[BridgeObj.SetBridgeUpdateForAnalysisFlag](../Definitions/Bridge_Objects/SetBridgeUpdateForAnalysisFlag.htm)



## SetActiveDOF

*Source file: `SAP2000_API_Fuctions/Analyze/SetActiveDOF.htm`*
...
[GetActiveDOF](GetActiveDOF.htm)



## SetRunCaseFlag

*Source file: `SAP2000_API_Fuctions/Analyze/SetRunCaseFlag.htm`*
...
[GetRunCaseFlag](GetRunCaseFlag.htm)
